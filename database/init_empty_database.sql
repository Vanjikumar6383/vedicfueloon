-- =========================================================================
-- VEDICFUELOON — PRODUCTION EMPTY DATABASE INITIALIZATION
-- Architecture: 3 Secure Relational Tables
--   1. products   (Product Catalog & Inventory)
--   2. customers  (Patron Directory with PII Security)
--   3. orders     (Transactional Financial Ledger)
-- Status: 100% Clean & Empty — Ready for Future Data Ingestion
-- =========================================================================

PRAGMA foreign_keys = ON;

-- -------------------------------------------------------------------------
-- TABLE 1: PRODUCTS (Empty - Ready for Future Product Catalog Data)
-- -------------------------------------------------------------------------
...
CREATE INDEX idx_products_cat_avail ON products(category, is_available);
CREATE INDEX idx_products_sku ON products(sku);

-- -------------------------------------------------------------------------
-- TABLE 2: CUSTOMERS (Empty - Ready for Future Registered / Guest Patrons)
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- TABLE 3: ORDERS (Empty - Ready for Future Orders & Tax Invoices)
-- -------------------------------------------------------------------------
CREATE TABLE orders (
...
-- =========================================================================
-- VERIFICATION NOTE:
-- All 3 tables start with exactly 0 rows.
-- Primary keys start at AUTOINCREMENT index 1 for the first future record.
-- =========================================================================
