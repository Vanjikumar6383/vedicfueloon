(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))d(h);new MutationObserver(h=>{for(const u of h)if(u.type==="childList")for(const b of u.addedNodes)b.tagName==="LINK"&&b.rel==="modulepreload"&&d(b)}).observe(document,{childList:!0,subtree:!0});function o(h){const u={};return h.integrity&&(u.integrity=h.integrity),h.referrerPolicy&&(u.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?u.credentials="include":h.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function d(h){if(h.ep)return;h.ep=!0;const u=o(h);fetch(h.href,u)}})();var ar=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},sr={exports:{}};/*!
  * Bootstrap v5.3.8 (https://getbootstrap.com/)
  * Copyright 2011-2025 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */(function(s,n){(function(o,d){s.exports=d()})(ar,function(){const o=new Map,d={set(i,e,t){o.has(i)||o.set(i,new Map);const a=o.get(i);a.has(e)||a.size===0?a.set(e,t):console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(a.keys())[0]}.`)},get:(i,e)=>o.has(i)&&o.get(i).get(e)||null,remove(i,e){if(!o.has(i))return;const t=o.get(i);t.delete(e),t.size===0&&o.delete(i)}},h="transitionend",u=i=>(i&&window.CSS&&window.CSS.escape&&(i=i.replace(/#([^\s"#']+)/g,(e,t)=>`#${CSS.escape(t)}`)),i),b=i=>i==null?`${i}`:Object.prototype.toString.call(i).match(/\s([a-z]+)/i)[1].toLowerCase(),E=i=>{i.dispatchEvent(new Event(h))},C=i=>!(!i||typeof i!="object")&&(i.jquery!==void 0&&(i=i[0]),i.nodeType!==void 0),L=i=>C(i)?i.jquery?i[0]:i:typeof i=="string"&&i.length>0?document.querySelector(u(i)):null,_=i=>{if(!C(i)||i.getClientRects().length===0)return!1;const e=getComputedStyle(i).getPropertyValue("visibility")==="visible",t=i.closest("details:not([open])");if(!t)return e;if(t!==i){const a=i.closest("summary");if(a&&a.parentNode!==t||a===null)return!1}return e},O=i=>!i||i.nodeType!==Node.ELEMENT_NODE||!!i.classList.contains("disabled")||(i.disabled!==void 0?i.disabled:i.hasAttribute("disabled")&&i.getAttribute("disabled")!=="false"),V=i=>{if(!document.documentElement.attachShadow)return null;if(typeof i.getRootNode=="function"){const e=i.getRootNode();return e instanceof ShadowRoot?e:null}return i instanceof ShadowRoot?i:i.parentNode?V(i.parentNode):null},G=()=>{},X=i=>{i.offsetHeight},Q=()=>window.jQuery&&!document.body.hasAttribute("data-bs-no-jquery")?window.jQuery:null,ge=[],ae=()=>document.documentElement.dir==="rtl",ce=i=>{var e;e=()=>{const t=Q();if(t){const a=i.NAME,l=t.fn[a];t.fn[a]=i.jQueryInterface,t.fn[a].Constructor=i,t.fn[a].noConflict=()=>(t.fn[a]=l,i.jQueryInterface)}},document.readyState==="loading"?(ge.length||document.addEventListener("DOMContentLoaded",()=>{for(const t of ge)t()}),ge.push(e)):e()},se=(i,e=[],t=i)=>typeof i=="function"?i.call(...e):t,Pi=(i,e,t=!0)=>{if(!t)return void se(i);const a=(p=>{if(!p)return 0;let{transitionDuration:m,transitionDelay:v}=window.getComputedStyle(p);const y=Number.parseFloat(m),w=Number.parseFloat(v);return y||w?(m=m.split(",")[0],v=v.split(",")[0],1e3*(Number.parseFloat(m)+Number.parseFloat(v))):0})(e)+5;let l=!1;const c=({target:p})=>{p===e&&(l=!0,e.removeEventListener(h,c),se(i))};e.addEventListener(h,c),setTimeout(()=>{l||E(e)},a)},Kt=(i,e,t,a)=>{const l=i.length;let c=i.indexOf(e);return c===-1?!t&&a?i[l-1]:i[0]:(c+=t?1:-1,a&&(c=(c+l)%l),i[Math.max(0,Math.min(c,l-1))])},Is=/[^.]*(?=\..*)\.|.*/,Os=/\..*/,Ds=/::\d+$/,Wt={};let Li=1;const Ni={mouseenter:"mouseover",mouseleave:"mouseout"},js=new Set(["click","dblclick","mouseup","mousedown","contextmenu","mousewheel","DOMMouseScroll","mouseover","mouseout","mousemove","selectstart","selectend","keydown","keypress","keyup","orientationchange","touchstart","touchmove","touchend","touchcancel","pointerdown","pointermove","pointerup","pointerleave","pointercancel","gesturestart","gesturechange","gestureend","focus","blur","change","reset","select","submit","focusin","focusout","load","unload","beforeunload","resize","move","DOMContentLoaded","readystatechange","error","abort","scroll"]);function Mi(i,e){return e&&`${e}::${Li++}`||i.uidEvent||Li++}function Bi(i){const e=Mi(i);return i.uidEvent=e,Wt[e]=Wt[e]||{},Wt[e]}function Fi(i,e,t=null){return Object.values(i).find(a=>a.callable===e&&a.delegationSelector===t)}function Ri(i,e,t){const a=typeof e=="string",l=a?t:e||t;let c=Hi(i);return js.has(c)||(c=i),[a,l,c]}function zi(i,e,t,a,l){if(typeof e!="string"||!i)return;let[c,p,m]=Ri(e,t,a);e in Ni&&(p=(S=>function($){if(!$.relatedTarget||$.relatedTarget!==$.delegateTarget&&!$.delegateTarget.contains($.relatedTarget))return S.call(this,$)})(p));const v=Bi(i),y=v[m]||(v[m]={}),w=Fi(y,p,c?t:null);if(w)return void(w.oneOff=w.oneOff&&l);const f=Mi(p,e.replace(Is,"")),T=c?function(x,S,$){return function A(B){const z=x.querySelectorAll(S);for(let{target:D}=B;D&&D!==this;D=D.parentNode)for(const P of z)if(P===D)return Ut(B,{delegateTarget:D}),A.oneOff&&g.off(x,B.type,S,$),$.apply(D,[B])}}(i,t,p):function(x,S){return function $(A){return Ut(A,{delegateTarget:x}),$.oneOff&&g.off(x,A.type,S),S.apply(x,[A])}}(i,p);T.delegationSelector=c?t:null,T.callable=p,T.oneOff=l,T.uidEvent=f,y[f]=T,i.addEventListener(m,T,c)}function qt(i,e,t,a,l){const c=Fi(e[t],a,l);c&&(i.removeEventListener(t,c,!!l),delete e[t][c.uidEvent])}function Ps(i,e,t,a){const l=e[t]||{};for(const[c,p]of Object.entries(l))c.includes(a)&&qt(i,e,t,p.callable,p.delegationSelector)}function Hi(i){return i=i.replace(Os,""),Ni[i]||i}const g={on(i,e,t,a){zi(i,e,t,a,!1)},one(i,e,t,a){zi(i,e,t,a,!0)},off(i,e,t,a){if(typeof e!="string"||!i)return;const[l,c,p]=Ri(e,t,a),m=p!==e,v=Bi(i),y=v[p]||{},w=e.startsWith(".");if(c===void 0){if(w)for(const f of Object.keys(v))Ps(i,v,f,e.slice(1));for(const[f,T]of Object.entries(y)){const x=f.replace(Ds,"");m&&!e.includes(x)||qt(i,v,p,T.callable,T.delegationSelector)}}else{if(!Object.keys(y).length)return;qt(i,v,p,c,l?t:null)}},trigger(i,e,t){if(typeof e!="string"||!i)return null;const a=Q();let l=null,c=!0,p=!0,m=!1;e!==Hi(e)&&a&&(l=a.Event(e,t),a(i).trigger(l),c=!l.isPropagationStopped(),p=!l.isImmediatePropagationStopped(),m=l.isDefaultPrevented());const v=Ut(new Event(e,{bubbles:c,cancelable:!0}),t);return m&&v.preventDefault(),p&&i.dispatchEvent(v),v.defaultPrevented&&l&&l.preventDefault(),v}};function Ut(i,e={}){for(const[t,a]of Object.entries(e))try{i[t]=a}catch{Object.defineProperty(i,t,{configurable:!0,get:()=>a})}return i}function Vi(i){if(i==="true")return!0;if(i==="false")return!1;if(i===Number(i).toString())return Number(i);if(i===""||i==="null")return null;if(typeof i!="string")return i;try{return JSON.parse(decodeURIComponent(i))}catch{return i}}function Gt(i){return i.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`)}const Ce={setDataAttribute(i,e,t){i.setAttribute(`data-bs-${Gt(e)}`,t)},removeDataAttribute(i,e){i.removeAttribute(`data-bs-${Gt(e)}`)},getDataAttributes(i){if(!i)return{};const e={},t=Object.keys(i.dataset).filter(a=>a.startsWith("bs")&&!a.startsWith("bsConfig"));for(const a of t){let l=a.replace(/^bs/,"");l=l.charAt(0).toLowerCase()+l.slice(1),e[l]=Vi(i.dataset[a])}return e},getDataAttribute:(i,e)=>Vi(i.getAttribute(`data-bs-${Gt(e)}`))};class ct{static get Default(){return{}}static get DefaultType(){return{}}static get NAME(){throw new Error('You have to implement the static method "NAME", for each component!')}_getConfig(e){return e=this._mergeConfigObj(e),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}_configAfterMerge(e){return e}_mergeConfigObj(e,t){const a=C(t)?Ce.getDataAttribute(t,"config"):{};return{...this.constructor.Default,...typeof a=="object"?a:{},...C(t)?Ce.getDataAttributes(t):{},...typeof e=="object"?e:{}}}_typeCheckConfig(e,t=this.constructor.DefaultType){for(const[a,l]of Object.entries(t)){const c=e[a],p=C(c)?"element":b(c);if(!new RegExp(l).test(p))throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${a}" provided type "${p}" but expected type "${l}".`)}}}class ve extends ct{constructor(e,t){super(),(e=L(e))&&(this._element=e,this._config=this._getConfig(t),d.set(this._element,this.constructor.DATA_KEY,this))}dispose(){d.remove(this._element,this.constructor.DATA_KEY),g.off(this._element,this.constructor.EVENT_KEY);for(const e of Object.getOwnPropertyNames(this))this[e]=null}_queueCallback(e,t,a=!0){Pi(e,t,a)}_getConfig(e){return e=this._mergeConfigObj(e,this._element),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}static getInstance(e){return d.get(L(e),this.DATA_KEY)}static getOrCreateInstance(e,t={}){return this.getInstance(e)||new this(e,typeof t=="object"?t:null)}static get VERSION(){return"5.3.8"}static get DATA_KEY(){return`bs.${this.NAME}`}static get EVENT_KEY(){return`.${this.DATA_KEY}`}static eventName(e){return`${e}${this.EVENT_KEY}`}}const Qt=i=>{let e=i.getAttribute("data-bs-target");if(!e||e==="#"){let t=i.getAttribute("href");if(!t||!t.includes("#")&&!t.startsWith("."))return null;t.includes("#")&&!t.startsWith("#")&&(t=`#${t.split("#")[1]}`),e=t&&t!=="#"?t.trim():null}return e?e.split(",").map(t=>u(t)).join(","):null},k={find:(i,e=document.documentElement)=>[].concat(...Element.prototype.querySelectorAll.call(e,i)),findOne:(i,e=document.documentElement)=>Element.prototype.querySelector.call(e,i),children:(i,e)=>[].concat(...i.children).filter(t=>t.matches(e)),parents(i,e){const t=[];let a=i.parentNode.closest(e);for(;a;)t.push(a),a=a.parentNode.closest(e);return t},prev(i,e){let t=i.previousElementSibling;for(;t;){if(t.matches(e))return[t];t=t.previousElementSibling}return[]},next(i,e){let t=i.nextElementSibling;for(;t;){if(t.matches(e))return[t];t=t.nextElementSibling}return[]},focusableChildren(i){const e=["a","button","input","textarea","select","details","[tabindex]",'[contenteditable="true"]'].map(t=>`${t}:not([tabindex^="-"])`).join(",");return this.find(e,i).filter(t=>!O(t)&&_(t))},getSelectorFromElement(i){const e=Qt(i);return e&&k.findOne(e)?e:null},getElementFromSelector(i){const e=Qt(i);return e?k.findOne(e):null},getMultipleElementsFromSelector(i){const e=Qt(i);return e?k.find(e):[]}},kt=(i,e="hide")=>{const t=`click.dismiss${i.EVENT_KEY}`,a=i.NAME;g.on(document,t,`[data-bs-dismiss="${a}"]`,function(l){if(["A","AREA"].includes(this.tagName)&&l.preventDefault(),O(this))return;const c=k.getElementFromSelector(this)||this.closest(`.${a}`);i.getOrCreateInstance(c)[e]()})},Ki=".bs.alert",Ls=`close${Ki}`,Ns=`closed${Ki}`;class dt extends ve{static get NAME(){return"alert"}close(){if(g.trigger(this._element,Ls).defaultPrevented)return;this._element.classList.remove("show");const e=this._element.classList.contains("fade");this._queueCallback(()=>this._destroyElement(),this._element,e)}_destroyElement(){this._element.remove(),g.trigger(this._element,Ns),this.dispose()}static jQueryInterface(e){return this.each(function(){const t=dt.getOrCreateInstance(this);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e](this)}})}}kt(dt,"close"),ce(dt);const Wi='[data-bs-toggle="button"]';class pt extends ve{static get NAME(){return"button"}toggle(){this._element.setAttribute("aria-pressed",this._element.classList.toggle("active"))}static jQueryInterface(e){return this.each(function(){const t=pt.getOrCreateInstance(this);e==="toggle"&&t[e]()})}}g.on(document,"click.bs.button.data-api",Wi,i=>{i.preventDefault();const e=i.target.closest(Wi);pt.getOrCreateInstance(e).toggle()}),ce(pt);const We=".bs.swipe",Ms=`touchstart${We}`,Bs=`touchmove${We}`,Fs=`touchend${We}`,Rs=`pointerdown${We}`,zs=`pointerup${We}`,Hs={endCallback:null,leftCallback:null,rightCallback:null},Vs={endCallback:"(function|null)",leftCallback:"(function|null)",rightCallback:"(function|null)"};class xt extends ct{constructor(e,t){super(),this._element=e,e&&xt.isSupported()&&(this._config=this._getConfig(t),this._deltaX=0,this._supportPointerEvents=!!window.PointerEvent,this._initEvents())}static get Default(){return Hs}static get DefaultType(){return Vs}static get NAME(){return"swipe"}dispose(){g.off(this._element,We)}_start(e){this._supportPointerEvents?this._eventIsPointerPenTouch(e)&&(this._deltaX=e.clientX):this._deltaX=e.touches[0].clientX}_end(e){this._eventIsPointerPenTouch(e)&&(this._deltaX=e.clientX-this._deltaX),this._handleSwipe(),se(this._config.endCallback)}_move(e){this._deltaX=e.touches&&e.touches.length>1?0:e.touches[0].clientX-this._deltaX}_handleSwipe(){const e=Math.abs(this._deltaX);if(e<=40)return;const t=e/this._deltaX;this._deltaX=0,t&&se(t>0?this._config.rightCallback:this._config.leftCallback)}_initEvents(){this._supportPointerEvents?(g.on(this._element,Rs,e=>this._start(e)),g.on(this._element,zs,e=>this._end(e)),this._element.classList.add("pointer-event")):(g.on(this._element,Ms,e=>this._start(e)),g.on(this._element,Bs,e=>this._move(e)),g.on(this._element,Fs,e=>this._end(e)))}_eventIsPointerPenTouch(e){return this._supportPointerEvents&&(e.pointerType==="pen"||e.pointerType==="touch")}static isSupported(){return"ontouchstart"in document.documentElement||navigator.maxTouchPoints>0}}const Te=".bs.carousel",qi=".data-api",Ks="ArrowLeft",Ws="ArrowRight",ut="next",qe="prev",Ue="left",$t="right",qs=`slide${Te}`,Yt=`slid${Te}`,Us=`keydown${Te}`,Gs=`mouseenter${Te}`,Qs=`mouseleave${Te}`,Ys=`dragstart${Te}`,Zs=`load${Te}${qi}`,Xs=`click${Te}${qi}`,Ui="carousel",Ct="active",Gi=".active",Qi=".carousel-item",Js=Gi+Qi,en={[Ks]:$t,[Ws]:Ue},tn={interval:5e3,keyboard:!0,pause:"hover",ride:!1,touch:!0,wrap:!0},an={interval:"(number|boolean)",keyboard:"boolean",pause:"(string|boolean)",ride:"(boolean|string)",touch:"boolean",wrap:"boolean"};class Ge extends ve{constructor(e,t){super(e,t),this._interval=null,this._activeElement=null,this._isSliding=!1,this.touchTimeout=null,this._swipeHelper=null,this._indicatorsElement=k.findOne(".carousel-indicators",this._element),this._addEventListeners(),this._config.ride===Ui&&this.cycle()}static get Default(){return tn}static get DefaultType(){return an}static get NAME(){return"carousel"}next(){this._slide(ut)}nextWhenVisible(){!document.hidden&&_(this._element)&&this.next()}prev(){this._slide(qe)}pause(){this._isSliding&&E(this._element),this._clearInterval()}cycle(){this._clearInterval(),this._updateInterval(),this._interval=setInterval(()=>this.nextWhenVisible(),this._config.interval)}_maybeEnableCycle(){this._config.ride&&(this._isSliding?g.one(this._element,Yt,()=>this.cycle()):this.cycle())}to(e){const t=this._getItems();if(e>t.length-1||e<0)return;if(this._isSliding)return void g.one(this._element,Yt,()=>this.to(e));const a=this._getItemIndex(this._getActive());if(a===e)return;const l=e>a?ut:qe;this._slide(l,t[e])}dispose(){this._swipeHelper&&this._swipeHelper.dispose(),super.dispose()}_configAfterMerge(e){return e.defaultInterval=e.interval,e}_addEventListeners(){this._config.keyboard&&g.on(this._element,Us,e=>this._keydown(e)),this._config.pause==="hover"&&(g.on(this._element,Gs,()=>this.pause()),g.on(this._element,Qs,()=>this._maybeEnableCycle())),this._config.touch&&xt.isSupported()&&this._addTouchEventListeners()}_addTouchEventListeners(){for(const t of k.find(".carousel-item img",this._element))g.on(t,Ys,a=>a.preventDefault());const e={leftCallback:()=>this._slide(this._directionToOrder(Ue)),rightCallback:()=>this._slide(this._directionToOrder($t)),endCallback:()=>{this._config.pause==="hover"&&(this.pause(),this.touchTimeout&&clearTimeout(this.touchTimeout),this.touchTimeout=setTimeout(()=>this._maybeEnableCycle(),500+this._config.interval))}};this._swipeHelper=new xt(this._element,e)}_keydown(e){if(/input|textarea/i.test(e.target.tagName))return;const t=en[e.key];t&&(e.preventDefault(),this._slide(this._directionToOrder(t)))}_getItemIndex(e){return this._getItems().indexOf(e)}_setActiveIndicatorElement(e){if(!this._indicatorsElement)return;const t=k.findOne(Gi,this._indicatorsElement);t.classList.remove(Ct),t.removeAttribute("aria-current");const a=k.findOne(`[data-bs-slide-to="${e}"]`,this._indicatorsElement);a&&(a.classList.add(Ct),a.setAttribute("aria-current","true"))}_updateInterval(){const e=this._activeElement||this._getActive();if(!e)return;const t=Number.parseInt(e.getAttribute("data-bs-interval"),10);this._config.interval=t||this._config.defaultInterval}_slide(e,t=null){if(this._isSliding)return;const a=this._getActive(),l=e===ut,c=t||Kt(this._getItems(),a,l,this._config.wrap);if(c===a)return;const p=this._getItemIndex(c),m=f=>g.trigger(this._element,f,{relatedTarget:c,direction:this._orderToDirection(e),from:this._getItemIndex(a),to:p});if(m(qs).defaultPrevented||!a||!c)return;const v=!!this._interval;this.pause(),this._isSliding=!0,this._setActiveIndicatorElement(p),this._activeElement=c;const y=l?"carousel-item-start":"carousel-item-end",w=l?"carousel-item-next":"carousel-item-prev";c.classList.add(w),X(c),a.classList.add(y),c.classList.add(y),this._queueCallback(()=>{c.classList.remove(y,w),c.classList.add(Ct),a.classList.remove(Ct,w,y),this._isSliding=!1,m(Yt)},a,this._isAnimated()),v&&this.cycle()}_isAnimated(){return this._element.classList.contains("slide")}_getActive(){return k.findOne(Js,this._element)}_getItems(){return k.find(Qi,this._element)}_clearInterval(){this._interval&&(clearInterval(this._interval),this._interval=null)}_directionToOrder(e){return ae()?e===Ue?qe:ut:e===Ue?ut:qe}_orderToDirection(e){return ae()?e===qe?Ue:$t:e===qe?$t:Ue}static jQueryInterface(e){return this.each(function(){const t=Ge.getOrCreateInstance(this,e);if(typeof e!="number"){if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e]()}}else t.to(e)})}}g.on(document,Xs,"[data-bs-slide], [data-bs-slide-to]",function(i){const e=k.getElementFromSelector(this);if(!e||!e.classList.contains(Ui))return;i.preventDefault();const t=Ge.getOrCreateInstance(e),a=this.getAttribute("data-bs-slide-to");return a?(t.to(a),void t._maybeEnableCycle()):Ce.getDataAttribute(this,"slide")==="next"?(t.next(),void t._maybeEnableCycle()):(t.prev(),void t._maybeEnableCycle())}),g.on(window,Zs,()=>{const i=k.find('[data-bs-ride="carousel"]');for(const e of i)Ge.getOrCreateInstance(e)}),ce(Ge);const ht=".bs.collapse",sn=`show${ht}`,nn=`shown${ht}`,on=`hide${ht}`,rn=`hidden${ht}`,ln=`click${ht}.data-api`,Zt="show",Qe="collapse",St="collapsing",cn=`:scope .${Qe} .${Qe}`,Xt='[data-bs-toggle="collapse"]',dn={parent:null,toggle:!0},pn={parent:"(null|element)",toggle:"boolean"};class Ye extends ve{constructor(e,t){super(e,t),this._isTransitioning=!1,this._triggerArray=[];const a=k.find(Xt);for(const l of a){const c=k.getSelectorFromElement(l),p=k.find(c).filter(m=>m===this._element);c!==null&&p.length&&this._triggerArray.push(l)}this._initializeChildren(),this._config.parent||this._addAriaAndCollapsedClass(this._triggerArray,this._isShown()),this._config.toggle&&this.toggle()}static get Default(){return dn}static get DefaultType(){return pn}static get NAME(){return"collapse"}toggle(){this._isShown()?this.hide():this.show()}show(){if(this._isTransitioning||this._isShown())return;let e=[];if(this._config.parent&&(e=this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(l=>l!==this._element).map(l=>Ye.getOrCreateInstance(l,{toggle:!1}))),e.length&&e[0]._isTransitioning||g.trigger(this._element,sn).defaultPrevented)return;for(const l of e)l.hide();const t=this._getDimension();this._element.classList.remove(Qe),this._element.classList.add(St),this._element.style[t]=0,this._addAriaAndCollapsedClass(this._triggerArray,!0),this._isTransitioning=!0;const a=`scroll${t[0].toUpperCase()+t.slice(1)}`;this._queueCallback(()=>{this._isTransitioning=!1,this._element.classList.remove(St),this._element.classList.add(Qe,Zt),this._element.style[t]="",g.trigger(this._element,nn)},this._element,!0),this._element.style[t]=`${this._element[a]}px`}hide(){if(this._isTransitioning||!this._isShown()||g.trigger(this._element,on).defaultPrevented)return;const e=this._getDimension();this._element.style[e]=`${this._element.getBoundingClientRect()[e]}px`,X(this._element),this._element.classList.add(St),this._element.classList.remove(Qe,Zt);for(const t of this._triggerArray){const a=k.getElementFromSelector(t);a&&!this._isShown(a)&&this._addAriaAndCollapsedClass([t],!1)}this._isTransitioning=!0,this._element.style[e]="",this._queueCallback(()=>{this._isTransitioning=!1,this._element.classList.remove(St),this._element.classList.add(Qe),g.trigger(this._element,rn)},this._element,!0)}_isShown(e=this._element){return e.classList.contains(Zt)}_configAfterMerge(e){return e.toggle=!!e.toggle,e.parent=L(e.parent),e}_getDimension(){return this._element.classList.contains("collapse-horizontal")?"width":"height"}_initializeChildren(){if(!this._config.parent)return;const e=this._getFirstLevelChildren(Xt);for(const t of e){const a=k.getElementFromSelector(t);a&&this._addAriaAndCollapsedClass([t],this._isShown(a))}}_getFirstLevelChildren(e){const t=k.find(cn,this._config.parent);return k.find(e,this._config.parent).filter(a=>!t.includes(a))}_addAriaAndCollapsedClass(e,t){if(e.length)for(const a of e)a.classList.toggle("collapsed",!t),a.setAttribute("aria-expanded",t)}static jQueryInterface(e){const t={};return typeof e=="string"&&/show|hide/.test(e)&&(t.toggle=!1),this.each(function(){const a=Ye.getOrCreateInstance(this,t);if(typeof e=="string"){if(a[e]===void 0)throw new TypeError(`No method named "${e}"`);a[e]()}})}}g.on(document,ln,Xt,function(i){(i.target.tagName==="A"||i.delegateTarget&&i.delegateTarget.tagName==="A")&&i.preventDefault();for(const e of k.getMultipleElementsFromSelector(this))Ye.getOrCreateInstance(e,{toggle:!1}).toggle()}),ce(Ye);var J="top",ne="bottom",oe="right",ee="left",At="auto",Ze=[J,ne,oe,ee],Pe="start",Xe="end",Yi="clippingParents",Jt="viewport",Je="popper",Zi="reference",ei=Ze.reduce(function(i,e){return i.concat([e+"-"+Pe,e+"-"+Xe])},[]),ti=[].concat(Ze,[At]).reduce(function(i,e){return i.concat([e,e+"-"+Pe,e+"-"+Xe])},[]),Xi="beforeRead",Ji="read",ea="afterRead",ta="beforeMain",ia="main",aa="afterMain",sa="beforeWrite",na="write",oa="afterWrite",ra=[Xi,Ji,ea,ta,ia,aa,sa,na,oa];function we(i){return i?(i.nodeName||"").toLowerCase():null}function re(i){if(i==null)return window;if(i.toString()!=="[object Window]"){var e=i.ownerDocument;return e&&e.defaultView||window}return i}function Le(i){return i instanceof re(i).Element||i instanceof Element}function de(i){return i instanceof re(i).HTMLElement||i instanceof HTMLElement}function ii(i){return typeof ShadowRoot<"u"&&(i instanceof re(i).ShadowRoot||i instanceof ShadowRoot)}const ai={name:"applyStyles",enabled:!0,phase:"write",fn:function(i){var e=i.state;Object.keys(e.elements).forEach(function(t){var a=e.styles[t]||{},l=e.attributes[t]||{},c=e.elements[t];de(c)&&we(c)&&(Object.assign(c.style,a),Object.keys(l).forEach(function(p){var m=l[p];m===!1?c.removeAttribute(p):c.setAttribute(p,m===!0?"":m)}))})},effect:function(i){var e=i.state,t={popper:{position:e.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(e.elements.popper.style,t.popper),e.styles=t,e.elements.arrow&&Object.assign(e.elements.arrow.style,t.arrow),function(){Object.keys(e.elements).forEach(function(a){var l=e.elements[a],c=e.attributes[a]||{},p=Object.keys(e.styles.hasOwnProperty(a)?e.styles[a]:t[a]).reduce(function(m,v){return m[v]="",m},{});de(l)&&we(l)&&(Object.assign(l.style,p),Object.keys(c).forEach(function(m){l.removeAttribute(m)}))})}},requires:["computeStyles"]};function _e(i){return i.split("-")[0]}var Ne=Math.max,Et=Math.min,et=Math.round;function si(){var i=navigator.userAgentData;return i!=null&&i.brands&&Array.isArray(i.brands)?i.brands.map(function(e){return e.brand+"/"+e.version}).join(" "):navigator.userAgent}function la(){return!/^((?!chrome|android).)*safari/i.test(si())}function tt(i,e,t){e===void 0&&(e=!1),t===void 0&&(t=!1);var a=i.getBoundingClientRect(),l=1,c=1;e&&de(i)&&(l=i.offsetWidth>0&&et(a.width)/i.offsetWidth||1,c=i.offsetHeight>0&&et(a.height)/i.offsetHeight||1);var p=(Le(i)?re(i):window).visualViewport,m=!la()&&t,v=(a.left+(m&&p?p.offsetLeft:0))/l,y=(a.top+(m&&p?p.offsetTop:0))/c,w=a.width/l,f=a.height/c;return{width:w,height:f,top:y,right:v+w,bottom:y+f,left:v,x:v,y}}function ni(i){var e=tt(i),t=i.offsetWidth,a=i.offsetHeight;return Math.abs(e.width-t)<=1&&(t=e.width),Math.abs(e.height-a)<=1&&(a=e.height),{x:i.offsetLeft,y:i.offsetTop,width:t,height:a}}function ca(i,e){var t=e.getRootNode&&e.getRootNode();if(i.contains(e))return!0;if(t&&ii(t)){var a=e;do{if(a&&i.isSameNode(a))return!0;a=a.parentNode||a.host}while(a)}return!1}function Se(i){return re(i).getComputedStyle(i)}function un(i){return["table","td","th"].indexOf(we(i))>=0}function Ie(i){return((Le(i)?i.ownerDocument:i.document)||window.document).documentElement}function Tt(i){return we(i)==="html"?i:i.assignedSlot||i.parentNode||(ii(i)?i.host:null)||Ie(i)}function da(i){return de(i)&&Se(i).position!=="fixed"?i.offsetParent:null}function mt(i){for(var e=re(i),t=da(i);t&&un(t)&&Se(t).position==="static";)t=da(t);return t&&(we(t)==="html"||we(t)==="body"&&Se(t).position==="static")?e:t||function(a){var l=/firefox/i.test(si());if(/Trident/i.test(si())&&de(a)&&Se(a).position==="fixed")return null;var c=Tt(a);for(ii(c)&&(c=c.host);de(c)&&["html","body"].indexOf(we(c))<0;){var p=Se(c);if(p.transform!=="none"||p.perspective!=="none"||p.contain==="paint"||["transform","perspective"].indexOf(p.willChange)!==-1||l&&p.willChange==="filter"||l&&p.filter&&p.filter!=="none")return c;c=c.parentNode}return null}(i)||e}function oi(i){return["top","bottom"].indexOf(i)>=0?"x":"y"}function gt(i,e,t){return Ne(i,Et(e,t))}function pa(i){return Object.assign({},{top:0,right:0,bottom:0,left:0},i)}function ua(i,e){return e.reduce(function(t,a){return t[a]=i,t},{})}const ha={name:"arrow",enabled:!0,phase:"main",fn:function(i){var e,t=i.state,a=i.name,l=i.options,c=t.elements.arrow,p=t.modifiersData.popperOffsets,m=_e(t.placement),v=oi(m),y=[ee,oe].indexOf(m)>=0?"height":"width";if(c&&p){var w=function(F,M){return pa(typeof(F=typeof F=="function"?F(Object.assign({},M.rects,{placement:M.placement})):F)!="number"?F:ua(F,Ze))}(l.padding,t),f=ni(c),T=v==="y"?J:ee,x=v==="y"?ne:oe,S=t.rects.reference[y]+t.rects.reference[v]-p[v]-t.rects.popper[y],$=p[v]-t.rects.reference[v],A=mt(c),B=A?v==="y"?A.clientHeight||0:A.clientWidth||0:0,z=S/2-$/2,D=w[T],P=B-f[y]-w[x],I=B/2-f[y]/2+z,j=gt(D,I,P),N=v;t.modifiersData[a]=((e={})[N]=j,e.centerOffset=j-I,e)}},effect:function(i){var e=i.state,t=i.options.element,a=t===void 0?"[data-popper-arrow]":t;a!=null&&(typeof a!="string"||(a=e.elements.popper.querySelector(a)))&&ca(e.elements.popper,a)&&(e.elements.arrow=a)},requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function it(i){return i.split("-")[1]}var hn={top:"auto",right:"auto",bottom:"auto",left:"auto"};function ma(i){var e,t=i.popper,a=i.popperRect,l=i.placement,c=i.variation,p=i.offsets,m=i.position,v=i.gpuAcceleration,y=i.adaptive,w=i.roundOffsets,f=i.isFixed,T=p.x,x=T===void 0?0:T,S=p.y,$=S===void 0?0:S,A=typeof w=="function"?w({x,y:$}):{x,y:$};x=A.x,$=A.y;var B=p.hasOwnProperty("x"),z=p.hasOwnProperty("y"),D=ee,P=J,I=window;if(y){var j=mt(t),N="clientHeight",F="clientWidth";j===re(t)&&Se(j=Ie(t)).position!=="static"&&m==="absolute"&&(N="scrollHeight",F="scrollWidth"),(l===J||(l===ee||l===oe)&&c===Xe)&&(P=ne,$-=(f&&j===I&&I.visualViewport?I.visualViewport.height:j[N])-a.height,$*=v?1:-1),l!==ee&&(l!==J&&l!==ne||c!==Xe)||(D=oe,x-=(f&&j===I&&I.visualViewport?I.visualViewport.width:j[F])-a.width,x*=v?1:-1)}var M,W=Object.assign({position:m},y&&hn),le=w===!0?function(be,te){var ue=be.x,he=be.y,K=te.devicePixelRatio||1;return{x:et(ue*K)/K||0,y:et(he*K)/K||0}}({x,y:$},re(t)):{x,y:$};return x=le.x,$=le.y,v?Object.assign({},W,((M={})[P]=z?"0":"",M[D]=B?"0":"",M.transform=(I.devicePixelRatio||1)<=1?"translate("+x+"px, "+$+"px)":"translate3d("+x+"px, "+$+"px, 0)",M)):Object.assign({},W,((e={})[P]=z?$+"px":"",e[D]=B?x+"px":"",e.transform="",e))}const ri={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:function(i){var e=i.state,t=i.options,a=t.gpuAcceleration,l=a===void 0||a,c=t.adaptive,p=c===void 0||c,m=t.roundOffsets,v=m===void 0||m,y={placement:_e(e.placement),variation:it(e.placement),popper:e.elements.popper,popperRect:e.rects.popper,gpuAcceleration:l,isFixed:e.options.strategy==="fixed"};e.modifiersData.popperOffsets!=null&&(e.styles.popper=Object.assign({},e.styles.popper,ma(Object.assign({},y,{offsets:e.modifiersData.popperOffsets,position:e.options.strategy,adaptive:p,roundOffsets:v})))),e.modifiersData.arrow!=null&&(e.styles.arrow=Object.assign({},e.styles.arrow,ma(Object.assign({},y,{offsets:e.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:v})))),e.attributes.popper=Object.assign({},e.attributes.popper,{"data-popper-placement":e.placement})},data:{}};var It={passive:!0};const li={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:function(i){var e=i.state,t=i.instance,a=i.options,l=a.scroll,c=l===void 0||l,p=a.resize,m=p===void 0||p,v=re(e.elements.popper),y=[].concat(e.scrollParents.reference,e.scrollParents.popper);return c&&y.forEach(function(w){w.addEventListener("scroll",t.update,It)}),m&&v.addEventListener("resize",t.update,It),function(){c&&y.forEach(function(w){w.removeEventListener("scroll",t.update,It)}),m&&v.removeEventListener("resize",t.update,It)}},data:{}};var mn={left:"right",right:"left",bottom:"top",top:"bottom"};function Ot(i){return i.replace(/left|right|bottom|top/g,function(e){return mn[e]})}var gn={start:"end",end:"start"};function ga(i){return i.replace(/start|end/g,function(e){return gn[e]})}function ci(i){var e=re(i);return{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}}function di(i){return tt(Ie(i)).left+ci(i).scrollLeft}function pi(i){var e=Se(i),t=e.overflow,a=e.overflowX,l=e.overflowY;return/auto|scroll|overlay|hidden/.test(t+l+a)}function va(i){return["html","body","#document"].indexOf(we(i))>=0?i.ownerDocument.body:de(i)&&pi(i)?i:va(Tt(i))}function vt(i,e){var t;e===void 0&&(e=[]);var a=va(i),l=a===((t=i.ownerDocument)==null?void 0:t.body),c=re(a),p=l?[c].concat(c.visualViewport||[],pi(a)?a:[]):a,m=e.concat(p);return l?m:m.concat(vt(Tt(p)))}function ui(i){return Object.assign({},i,{left:i.x,top:i.y,right:i.x+i.width,bottom:i.y+i.height})}function fa(i,e,t){return e===Jt?ui(function(a,l){var c=re(a),p=Ie(a),m=c.visualViewport,v=p.clientWidth,y=p.clientHeight,w=0,f=0;if(m){v=m.width,y=m.height;var T=la();(T||!T&&l==="fixed")&&(w=m.offsetLeft,f=m.offsetTop)}return{width:v,height:y,x:w+di(a),y:f}}(i,t)):Le(e)?function(a,l){var c=tt(a,!1,l==="fixed");return c.top=c.top+a.clientTop,c.left=c.left+a.clientLeft,c.bottom=c.top+a.clientHeight,c.right=c.left+a.clientWidth,c.width=a.clientWidth,c.height=a.clientHeight,c.x=c.left,c.y=c.top,c}(e,t):ui(function(a){var l,c=Ie(a),p=ci(a),m=(l=a.ownerDocument)==null?void 0:l.body,v=Ne(c.scrollWidth,c.clientWidth,m?m.scrollWidth:0,m?m.clientWidth:0),y=Ne(c.scrollHeight,c.clientHeight,m?m.scrollHeight:0,m?m.clientHeight:0),w=-p.scrollLeft+di(a),f=-p.scrollTop;return Se(m||c).direction==="rtl"&&(w+=Ne(c.clientWidth,m?m.clientWidth:0)-v),{width:v,height:y,x:w,y:f}}(Ie(i)))}function ba(i){var e,t=i.reference,a=i.element,l=i.placement,c=l?_e(l):null,p=l?it(l):null,m=t.x+t.width/2-a.width/2,v=t.y+t.height/2-a.height/2;switch(c){case J:e={x:m,y:t.y-a.height};break;case ne:e={x:m,y:t.y+t.height};break;case oe:e={x:t.x+t.width,y:v};break;case ee:e={x:t.x-a.width,y:v};break;default:e={x:t.x,y:t.y}}var y=c?oi(c):null;if(y!=null){var w=y==="y"?"height":"width";switch(p){case Pe:e[y]=e[y]-(t[w]/2-a[w]/2);break;case Xe:e[y]=e[y]+(t[w]/2-a[w]/2)}}return e}function at(i,e){e===void 0&&(e={});var t=e,a=t.placement,l=a===void 0?i.placement:a,c=t.strategy,p=c===void 0?i.strategy:c,m=t.boundary,v=m===void 0?Yi:m,y=t.rootBoundary,w=y===void 0?Jt:y,f=t.elementContext,T=f===void 0?Je:f,x=t.altBoundary,S=x!==void 0&&x,$=t.padding,A=$===void 0?0:$,B=pa(typeof A!="number"?A:ua(A,Ze)),z=T===Je?Zi:Je,D=i.rects.popper,P=i.elements[S?z:T],I=function(te,ue,he,K){var ke=ue==="clippingParents"?function(R){var ie=vt(Tt(R)),me=["absolute","fixed"].indexOf(Se(R).position)>=0&&de(R)?mt(R):R;return Le(me)?ie.filter(function(De){return Le(De)&&ca(De,me)&&we(De)!=="body"}):[]}(te):[].concat(ue),xe=[].concat(ke,[he]),ot=xe[0],U=xe.reduce(function(R,ie){var me=fa(te,ie,K);return R.top=Ne(me.top,R.top),R.right=Et(me.right,R.right),R.bottom=Et(me.bottom,R.bottom),R.left=Ne(me.left,R.left),R},fa(te,ot,K));return U.width=U.right-U.left,U.height=U.bottom-U.top,U.x=U.left,U.y=U.top,U}(Le(P)?P:P.contextElement||Ie(i.elements.popper),v,w,p),j=tt(i.elements.reference),N=ba({reference:j,element:D,placement:l}),F=ui(Object.assign({},D,N)),M=T===Je?F:j,W={top:I.top-M.top+B.top,bottom:M.bottom-I.bottom+B.bottom,left:I.left-M.left+B.left,right:M.right-I.right+B.right},le=i.modifiersData.offset;if(T===Je&&le){var be=le[l];Object.keys(W).forEach(function(te){var ue=[oe,ne].indexOf(te)>=0?1:-1,he=[J,ne].indexOf(te)>=0?"y":"x";W[te]+=be[he]*ue})}return W}function vn(i,e){e===void 0&&(e={});var t=e,a=t.placement,l=t.boundary,c=t.rootBoundary,p=t.padding,m=t.flipVariations,v=t.allowedAutoPlacements,y=v===void 0?ti:v,w=it(a),f=w?m?ei:ei.filter(function(S){return it(S)===w}):Ze,T=f.filter(function(S){return y.indexOf(S)>=0});T.length===0&&(T=f);var x=T.reduce(function(S,$){return S[$]=at(i,{placement:$,boundary:l,rootBoundary:c,padding:p})[_e($)],S},{});return Object.keys(x).sort(function(S,$){return x[S]-x[$]})}const ya={name:"flip",enabled:!0,phase:"main",fn:function(i){var e=i.state,t=i.options,a=i.name;if(!e.modifiersData[a]._skip){for(var l=t.mainAxis,c=l===void 0||l,p=t.altAxis,m=p===void 0||p,v=t.fallbackPlacements,y=t.padding,w=t.boundary,f=t.rootBoundary,T=t.altBoundary,x=t.flipVariations,S=x===void 0||x,$=t.allowedAutoPlacements,A=e.options.placement,B=_e(A),z=v||(B!==A&&S?function(R){if(_e(R)===At)return[];var ie=Ot(R);return[ga(R),ie,ga(ie)]}(A):[Ot(A)]),D=[A].concat(z).reduce(function(R,ie){return R.concat(_e(ie)===At?vn(e,{placement:ie,boundary:w,rootBoundary:f,padding:y,flipVariations:S,allowedAutoPlacements:$}):ie)},[]),P=e.rects.reference,I=e.rects.popper,j=new Map,N=!0,F=D[0],M=0;M<D.length;M++){var W=D[M],le=_e(W),be=it(W)===Pe,te=[J,ne].indexOf(le)>=0,ue=te?"width":"height",he=at(e,{placement:W,boundary:w,rootBoundary:f,altBoundary:T,padding:y}),K=te?be?oe:ee:be?ne:J;P[ue]>I[ue]&&(K=Ot(K));var ke=Ot(K),xe=[];if(c&&xe.push(he[le]<=0),m&&xe.push(he[K]<=0,he[ke]<=0),xe.every(function(R){return R})){F=W,N=!1;break}j.set(W,xe)}if(N)for(var ot=function(R){var ie=D.find(function(me){var De=j.get(me);if(De)return De.slice(0,R).every(function(Rt){return Rt})});if(ie)return F=ie,"break"},U=S?3:1;U>0&&ot(U)!=="break";U--);e.placement!==F&&(e.modifiersData[a]._skip=!0,e.placement=F,e.reset=!0)}},requiresIfExists:["offset"],data:{_skip:!1}};function wa(i,e,t){return t===void 0&&(t={x:0,y:0}),{top:i.top-e.height-t.y,right:i.right-e.width+t.x,bottom:i.bottom-e.height+t.y,left:i.left-e.width-t.x}}function _a(i){return[J,oe,ne,ee].some(function(e){return i[e]>=0})}const ka={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:function(i){var e=i.state,t=i.name,a=e.rects.reference,l=e.rects.popper,c=e.modifiersData.preventOverflow,p=at(e,{elementContext:"reference"}),m=at(e,{altBoundary:!0}),v=wa(p,a),y=wa(m,l,c),w=_a(v),f=_a(y);e.modifiersData[t]={referenceClippingOffsets:v,popperEscapeOffsets:y,isReferenceHidden:w,hasPopperEscaped:f},e.attributes.popper=Object.assign({},e.attributes.popper,{"data-popper-reference-hidden":w,"data-popper-escaped":f})}},xa={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:function(i){var e=i.state,t=i.options,a=i.name,l=t.offset,c=l===void 0?[0,0]:l,p=ti.reduce(function(w,f){return w[f]=function(T,x,S){var $=_e(T),A=[ee,J].indexOf($)>=0?-1:1,B=typeof S=="function"?S(Object.assign({},x,{placement:T})):S,z=B[0],D=B[1];return z=z||0,D=(D||0)*A,[ee,oe].indexOf($)>=0?{x:D,y:z}:{x:z,y:D}}(f,e.rects,c),w},{}),m=p[e.placement],v=m.x,y=m.y;e.modifiersData.popperOffsets!=null&&(e.modifiersData.popperOffsets.x+=v,e.modifiersData.popperOffsets.y+=y),e.modifiersData[a]=p}},hi={name:"popperOffsets",enabled:!0,phase:"read",fn:function(i){var e=i.state,t=i.name;e.modifiersData[t]=ba({reference:e.rects.reference,element:e.rects.popper,placement:e.placement})},data:{}},$a={name:"preventOverflow",enabled:!0,phase:"main",fn:function(i){var e=i.state,t=i.options,a=i.name,l=t.mainAxis,c=l===void 0||l,p=t.altAxis,m=p!==void 0&&p,v=t.boundary,y=t.rootBoundary,w=t.altBoundary,f=t.padding,T=t.tether,x=T===void 0||T,S=t.tetherOffset,$=S===void 0?0:S,A=at(e,{boundary:v,rootBoundary:y,padding:f,altBoundary:w}),B=_e(e.placement),z=it(e.placement),D=!z,P=oi(B),I=P==="x"?"y":"x",j=e.modifiersData.popperOffsets,N=e.rects.reference,F=e.rects.popper,M=typeof $=="function"?$(Object.assign({},e.rects,{placement:e.placement})):$,W=typeof M=="number"?{mainAxis:M,altAxis:M}:Object.assign({mainAxis:0,altAxis:0},M),le=e.modifiersData.offset?e.modifiersData.offset[e.placement]:null,be={x:0,y:0};if(j){if(c){var te,ue=P==="y"?J:ee,he=P==="y"?ne:oe,K=P==="y"?"height":"width",ke=j[P],xe=ke+A[ue],ot=ke-A[he],U=x?-F[K]/2:0,R=z===Pe?N[K]:F[K],ie=z===Pe?-F[K]:-N[K],me=e.elements.arrow,De=x&&me?ni(me):{width:0,height:0},Rt=e.modifiersData["arrow#persistent"]?e.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},ds=Rt[ue],ps=Rt[he],zt=gt(0,N[K],De[K]),Qo=D?N[K]/2-U-zt-ds-W.mainAxis:R-zt-ds-W.mainAxis,Yo=D?-N[K]/2+U+zt+ps+W.mainAxis:ie+zt+ps+W.mainAxis,Ai=e.elements.arrow&&mt(e.elements.arrow),Zo=Ai?P==="y"?Ai.clientTop||0:Ai.clientLeft||0:0,us=(te=le==null?void 0:le[P])!=null?te:0,Xo=ke+Yo-us,hs=gt(x?Et(xe,ke+Qo-us-Zo):xe,ke,x?Ne(ot,Xo):ot);j[P]=hs,be[P]=hs-ke}if(m){var ms,Jo=P==="x"?J:ee,er=P==="x"?ne:oe,Ke=j[I],Ht=I==="y"?"height":"width",gs=Ke+A[Jo],vs=Ke-A[er],Ei=[J,ee].indexOf(B)!==-1,fs=(ms=le==null?void 0:le[I])!=null?ms:0,bs=Ei?gs:Ke-N[Ht]-F[Ht]-fs+W.altAxis,ys=Ei?Ke+N[Ht]+F[Ht]-fs-W.altAxis:vs,ws=x&&Ei?function(tr,ir,Ti){var _s=gt(tr,ir,Ti);return _s>Ti?Ti:_s}(bs,Ke,ys):gt(x?bs:gs,Ke,x?ys:vs);j[I]=ws,be[I]=ws-Ke}e.modifiersData[a]=be}},requiresIfExists:["offset"]};function fn(i,e,t){t===void 0&&(t=!1);var a,l,c=de(e),p=de(e)&&function(f){var T=f.getBoundingClientRect(),x=et(T.width)/f.offsetWidth||1,S=et(T.height)/f.offsetHeight||1;return x!==1||S!==1}(e),m=Ie(e),v=tt(i,p,t),y={scrollLeft:0,scrollTop:0},w={x:0,y:0};return(c||!c&&!t)&&((we(e)!=="body"||pi(m))&&(y=(a=e)!==re(a)&&de(a)?{scrollLeft:(l=a).scrollLeft,scrollTop:l.scrollTop}:ci(a)),de(e)?((w=tt(e,!0)).x+=e.clientLeft,w.y+=e.clientTop):m&&(w.x=di(m))),{x:v.left+y.scrollLeft-w.x,y:v.top+y.scrollTop-w.y,width:v.width,height:v.height}}function bn(i){var e=new Map,t=new Set,a=[];function l(c){t.add(c.name),[].concat(c.requires||[],c.requiresIfExists||[]).forEach(function(p){if(!t.has(p)){var m=e.get(p);m&&l(m)}}),a.push(c)}return i.forEach(function(c){e.set(c.name,c)}),i.forEach(function(c){t.has(c.name)||l(c)}),a}var Ca={placement:"bottom",modifiers:[],strategy:"absolute"};function Sa(){for(var i=arguments.length,e=new Array(i),t=0;t<i;t++)e[t]=arguments[t];return!e.some(function(a){return!(a&&typeof a.getBoundingClientRect=="function")})}function Dt(i){i===void 0&&(i={});var e=i,t=e.defaultModifiers,a=t===void 0?[]:t,l=e.defaultOptions,c=l===void 0?Ca:l;return function(p,m,v){v===void 0&&(v=c);var y,w,f={placement:"bottom",orderedModifiers:[],options:Object.assign({},Ca,c),modifiersData:{},elements:{reference:p,popper:m},attributes:{},styles:{}},T=[],x=!1,S={state:f,setOptions:function(A){var B=typeof A=="function"?A(f.options):A;$(),f.options=Object.assign({},c,f.options,B),f.scrollParents={reference:Le(p)?vt(p):p.contextElement?vt(p.contextElement):[],popper:vt(m)};var z,D,P=function(I){var j=bn(I);return ra.reduce(function(N,F){return N.concat(j.filter(function(M){return M.phase===F}))},[])}((z=[].concat(a,f.options.modifiers),D=z.reduce(function(I,j){var N=I[j.name];return I[j.name]=N?Object.assign({},N,j,{options:Object.assign({},N.options,j.options),data:Object.assign({},N.data,j.data)}):j,I},{}),Object.keys(D).map(function(I){return D[I]})));return f.orderedModifiers=P.filter(function(I){return I.enabled}),f.orderedModifiers.forEach(function(I){var j=I.name,N=I.options,F=N===void 0?{}:N,M=I.effect;if(typeof M=="function"){var W=M({state:f,name:j,instance:S,options:F});T.push(W||function(){})}}),S.update()},forceUpdate:function(){if(!x){var A=f.elements,B=A.reference,z=A.popper;if(Sa(B,z)){f.rects={reference:fn(B,mt(z),f.options.strategy==="fixed"),popper:ni(z)},f.reset=!1,f.placement=f.options.placement,f.orderedModifiers.forEach(function(M){return f.modifiersData[M.name]=Object.assign({},M.data)});for(var D=0;D<f.orderedModifiers.length;D++)if(f.reset!==!0){var P=f.orderedModifiers[D],I=P.fn,j=P.options,N=j===void 0?{}:j,F=P.name;typeof I=="function"&&(f=I({state:f,options:N,name:F,instance:S})||f)}else f.reset=!1,D=-1}}},update:(y=function(){return new Promise(function(A){S.forceUpdate(),A(f)})},function(){return w||(w=new Promise(function(A){Promise.resolve().then(function(){w=void 0,A(y())})})),w}),destroy:function(){$(),x=!0}};if(!Sa(p,m))return S;function $(){T.forEach(function(A){return A()}),T=[]}return S.setOptions(v).then(function(A){!x&&v.onFirstUpdate&&v.onFirstUpdate(A)}),S}}var yn=Dt(),wn=Dt({defaultModifiers:[li,hi,ri,ai]}),mi=Dt({defaultModifiers:[li,hi,ri,ai,xa,ya,$a,ha,ka]});const Aa=Object.freeze(Object.defineProperty({__proto__:null,afterMain:aa,afterRead:ea,afterWrite:oa,applyStyles:ai,arrow:ha,auto:At,basePlacements:Ze,beforeMain:ta,beforeRead:Xi,beforeWrite:sa,bottom:ne,clippingParents:Yi,computeStyles:ri,createPopper:mi,createPopperBase:yn,createPopperLite:wn,detectOverflow:at,end:Xe,eventListeners:li,flip:ya,hide:ka,left:ee,main:ia,modifierPhases:ra,offset:xa,placements:ti,popper:Je,popperGenerator:Dt,popperOffsets:hi,preventOverflow:$a,read:Ji,reference:Zi,right:oe,start:Pe,top:J,variationPlacements:ei,viewport:Jt,write:na},Symbol.toStringTag,{value:"Module"})),Ea="dropdown",Me=".bs.dropdown",gi=".data-api",_n="ArrowUp",Ta="ArrowDown",kn=`hide${Me}`,xn=`hidden${Me}`,$n=`show${Me}`,Cn=`shown${Me}`,Ia=`click${Me}${gi}`,Oa=`keydown${Me}${gi}`,Sn=`keyup${Me}${gi}`,st="show",Be='[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',An=`${Be}.${st}`,jt=".dropdown-menu",En=ae()?"top-end":"top-start",Tn=ae()?"top-start":"top-end",In=ae()?"bottom-end":"bottom-start",On=ae()?"bottom-start":"bottom-end",Dn=ae()?"left-start":"right-start",jn=ae()?"right-start":"left-start",Pn={autoClose:!0,boundary:"clippingParents",display:"dynamic",offset:[0,2],popperConfig:null,reference:"toggle"},Ln={autoClose:"(boolean|string)",boundary:"(string|element)",display:"string",offset:"(array|string|function)",popperConfig:"(null|object|function)",reference:"(string|element|object)"};class fe extends ve{constructor(e,t){super(e,t),this._popper=null,this._parent=this._element.parentNode,this._menu=k.next(this._element,jt)[0]||k.prev(this._element,jt)[0]||k.findOne(jt,this._parent),this._inNavbar=this._detectNavbar()}static get Default(){return Pn}static get DefaultType(){return Ln}static get NAME(){return Ea}toggle(){return this._isShown()?this.hide():this.show()}show(){if(O(this._element)||this._isShown())return;const e={relatedTarget:this._element};if(!g.trigger(this._element,$n,e).defaultPrevented){if(this._createPopper(),"ontouchstart"in document.documentElement&&!this._parent.closest(".navbar-nav"))for(const t of[].concat(...document.body.children))g.on(t,"mouseover",G);this._element.focus(),this._element.setAttribute("aria-expanded",!0),this._menu.classList.add(st),this._element.classList.add(st),g.trigger(this._element,Cn,e)}}hide(){if(O(this._element)||!this._isShown())return;const e={relatedTarget:this._element};this._completeHide(e)}dispose(){this._popper&&this._popper.destroy(),super.dispose()}update(){this._inNavbar=this._detectNavbar(),this._popper&&this._popper.update()}_completeHide(e){if(!g.trigger(this._element,kn,e).defaultPrevented){if("ontouchstart"in document.documentElement)for(const t of[].concat(...document.body.children))g.off(t,"mouseover",G);this._popper&&this._popper.destroy(),this._menu.classList.remove(st),this._element.classList.remove(st),this._element.setAttribute("aria-expanded","false"),Ce.removeDataAttribute(this._menu,"popper"),g.trigger(this._element,xn,e)}}_getConfig(e){if(typeof(e=super._getConfig(e)).reference=="object"&&!C(e.reference)&&typeof e.reference.getBoundingClientRect!="function")throw new TypeError(`${Ea.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);return e}_createPopper(){if(Aa===void 0)throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org/docs/v2/)");let e=this._element;this._config.reference==="parent"?e=this._parent:C(this._config.reference)?e=L(this._config.reference):typeof this._config.reference=="object"&&(e=this._config.reference);const t=this._getPopperConfig();this._popper=mi(e,this._menu,t)}_isShown(){return this._menu.classList.contains(st)}_getPlacement(){const e=this._parent;if(e.classList.contains("dropend"))return Dn;if(e.classList.contains("dropstart"))return jn;if(e.classList.contains("dropup-center"))return"top";if(e.classList.contains("dropdown-center"))return"bottom";const t=getComputedStyle(this._menu).getPropertyValue("--bs-position").trim()==="end";return e.classList.contains("dropup")?t?Tn:En:t?On:In}_detectNavbar(){return this._element.closest(".navbar")!==null}_getOffset(){const{offset:e}=this._config;return typeof e=="string"?e.split(",").map(t=>Number.parseInt(t,10)):typeof e=="function"?t=>e(t,this._element):e}_getPopperConfig(){const e={placement:this._getPlacement(),modifiers:[{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"offset",options:{offset:this._getOffset()}}]};return(this._inNavbar||this._config.display==="static")&&(Ce.setDataAttribute(this._menu,"popper","static"),e.modifiers=[{name:"applyStyles",enabled:!1}]),{...e,...se(this._config.popperConfig,[void 0,e])}}_selectMenuItem({key:e,target:t}){const a=k.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",this._menu).filter(l=>_(l));a.length&&Kt(a,t,e===Ta,!a.includes(t)).focus()}static jQueryInterface(e){return this.each(function(){const t=fe.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0)throw new TypeError(`No method named "${e}"`);t[e]()}})}static clearMenus(e){if(e.button===2||e.type==="keyup"&&e.key!=="Tab")return;const t=k.find(An);for(const a of t){const l=fe.getInstance(a);if(!l||l._config.autoClose===!1)continue;const c=e.composedPath(),p=c.includes(l._menu);if(c.includes(l._element)||l._config.autoClose==="inside"&&!p||l._config.autoClose==="outside"&&p||l._menu.contains(e.target)&&(e.type==="keyup"&&e.key==="Tab"||/input|select|option|textarea|form/i.test(e.target.tagName)))continue;const m={relatedTarget:l._element};e.type==="click"&&(m.clickEvent=e),l._completeHide(m)}}static dataApiKeydownHandler(e){const t=/input|textarea/i.test(e.target.tagName),a=e.key==="Escape",l=[_n,Ta].includes(e.key);if(!l&&!a||t&&!a)return;e.preventDefault();const c=this.matches(Be)?this:k.prev(this,Be)[0]||k.next(this,Be)[0]||k.findOne(Be,e.delegateTarget.parentNode),p=fe.getOrCreateInstance(c);if(l)return e.stopPropagation(),p.show(),void p._selectMenuItem(e);p._isShown()&&(e.stopPropagation(),p.hide(),c.focus())}}g.on(document,Oa,Be,fe.dataApiKeydownHandler),g.on(document,Oa,jt,fe.dataApiKeydownHandler),g.on(document,Ia,fe.clearMenus),g.on(document,Sn,fe.clearMenus),g.on(document,Ia,Be,function(i){i.preventDefault(),fe.getOrCreateInstance(this).toggle()}),ce(fe);const Da="backdrop",ja="show",Pa=`mousedown.bs.${Da}`,Nn={className:"modal-backdrop",clickCallback:null,isAnimated:!1,isVisible:!0,rootElement:"body"},Mn={className:"string",clickCallback:"(function|null)",isAnimated:"boolean",isVisible:"boolean",rootElement:"(element|string)"};class La extends ct{constructor(e){super(),this._config=this._getConfig(e),this._isAppended=!1,this._element=null}static get Default(){return Nn}static get DefaultType(){return Mn}static get NAME(){return Da}show(e){if(!this._config.isVisible)return void se(e);this._append();const t=this._getElement();this._config.isAnimated&&X(t),t.classList.add(ja),this._emulateAnimation(()=>{se(e)})}hide(e){this._config.isVisible?(this._getElement().classList.remove(ja),this._emulateAnimation(()=>{this.dispose(),se(e)})):se(e)}dispose(){this._isAppended&&(g.off(this._element,Pa),this._element.remove(),this._isAppended=!1)}_getElement(){if(!this._element){const e=document.createElement("div");e.className=this._config.className,this._config.isAnimated&&e.classList.add("fade"),this._element=e}return this._element}_configAfterMerge(e){return e.rootElement=L(e.rootElement),e}_append(){if(this._isAppended)return;const e=this._getElement();this._config.rootElement.append(e),g.on(e,Pa,()=>{se(this._config.clickCallback)}),this._isAppended=!0}_emulateAnimation(e){Pi(e,this._getElement(),this._config.isAnimated)}}const Pt=".bs.focustrap",Bn=`focusin${Pt}`,Fn=`keydown.tab${Pt}`,Na="backward",Rn={autofocus:!0,trapElement:null},zn={autofocus:"boolean",trapElement:"element"};class Ma extends ct{constructor(e){super(),this._config=this._getConfig(e),this._isActive=!1,this._lastTabNavDirection=null}static get Default(){return Rn}static get DefaultType(){return zn}static get NAME(){return"focustrap"}activate(){this._isActive||(this._config.autofocus&&this._config.trapElement.focus(),g.off(document,Pt),g.on(document,Bn,e=>this._handleFocusin(e)),g.on(document,Fn,e=>this._handleKeydown(e)),this._isActive=!0)}deactivate(){this._isActive&&(this._isActive=!1,g.off(document,Pt))}_handleFocusin(e){const{trapElement:t}=this._config;if(e.target===document||e.target===t||t.contains(e.target))return;const a=k.focusableChildren(t);a.length===0?t.focus():this._lastTabNavDirection===Na?a[a.length-1].focus():a[0].focus()}_handleKeydown(e){e.key==="Tab"&&(this._lastTabNavDirection=e.shiftKey?Na:"forward")}}const Ba=".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",Fa=".sticky-top",Lt="padding-right",Ra="margin-right";class vi{constructor(){this._element=document.body}getWidth(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}hide(){const e=this.getWidth();this._disableOverFlow(),this._setElementAttributes(this._element,Lt,t=>t+e),this._setElementAttributes(Ba,Lt,t=>t+e),this._setElementAttributes(Fa,Ra,t=>t-e)}reset(){this._resetElementAttributes(this._element,"overflow"),this._resetElementAttributes(this._element,Lt),this._resetElementAttributes(Ba,Lt),this._resetElementAttributes(Fa,Ra)}isOverflowing(){return this.getWidth()>0}_disableOverFlow(){this._saveInitialAttribute(this._element,"overflow"),this._element.style.overflow="hidden"}_setElementAttributes(e,t,a){const l=this.getWidth();this._applyManipulationCallback(e,c=>{if(c!==this._element&&window.innerWidth>c.clientWidth+l)return;this._saveInitialAttribute(c,t);const p=window.getComputedStyle(c).getPropertyValue(t);c.style.setProperty(t,`${a(Number.parseFloat(p))}px`)})}_saveInitialAttribute(e,t){const a=e.style.getPropertyValue(t);a&&Ce.setDataAttribute(e,t,a)}_resetElementAttributes(e,t){this._applyManipulationCallback(e,a=>{const l=Ce.getDataAttribute(a,t);l!==null?(Ce.removeDataAttribute(a,t),a.style.setProperty(t,l)):a.style.removeProperty(t)})}_applyManipulationCallback(e,t){if(C(e))t(e);else for(const a of k.find(e,this._element))t(a)}}const pe=".bs.modal",Hn=`hide${pe}`,Vn=`hidePrevented${pe}`,za=`hidden${pe}`,Ha=`show${pe}`,Kn=`shown${pe}`,Wn=`resize${pe}`,qn=`click.dismiss${pe}`,Un=`mousedown.dismiss${pe}`,Gn=`keydown.dismiss${pe}`,Qn=`click${pe}.data-api`,Va="modal-open",Ka="show",fi="modal-static",Yn={backdrop:!0,focus:!0,keyboard:!0},Zn={backdrop:"(boolean|string)",focus:"boolean",keyboard:"boolean"};class Fe extends ve{constructor(e,t){super(e,t),this._dialog=k.findOne(".modal-dialog",this._element),this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._isShown=!1,this._isTransitioning=!1,this._scrollBar=new vi,this._addEventListeners()}static get Default(){return Yn}static get DefaultType(){return Zn}static get NAME(){return"modal"}toggle(e){return this._isShown?this.hide():this.show(e)}show(e){this._isShown||this._isTransitioning||g.trigger(this._element,Ha,{relatedTarget:e}).defaultPrevented||(this._isShown=!0,this._isTransitioning=!0,this._scrollBar.hide(),document.body.classList.add(Va),this._adjustDialog(),this._backdrop.show(()=>this._showElement(e)))}hide(){this._isShown&&!this._isTransitioning&&(g.trigger(this._element,Hn).defaultPrevented||(this._isShown=!1,this._isTransitioning=!0,this._focustrap.deactivate(),this._element.classList.remove(Ka),this._queueCallback(()=>this._hideModal(),this._element,this._isAnimated())))}dispose(){g.off(window,pe),g.off(this._dialog,pe),this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}handleUpdate(){this._adjustDialog()}_initializeBackDrop(){return new La({isVisible:!!this._config.backdrop,isAnimated:this._isAnimated()})}_initializeFocusTrap(){return new Ma({trapElement:this._element})}_showElement(e){document.body.contains(this._element)||document.body.append(this._element),this._element.style.display="block",this._element.removeAttribute("aria-hidden"),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.scrollTop=0;const t=k.findOne(".modal-body",this._dialog);t&&(t.scrollTop=0),X(this._element),this._element.classList.add(Ka),this._queueCallback(()=>{this._config.focus&&this._focustrap.activate(),this._isTransitioning=!1,g.trigger(this._element,Kn,{relatedTarget:e})},this._dialog,this._isAnimated())}_addEventListeners(){g.on(this._element,Gn,e=>{e.key==="Escape"&&(this._config.keyboard?this.hide():this._triggerBackdropTransition())}),g.on(window,Wn,()=>{this._isShown&&!this._isTransitioning&&this._adjustDialog()}),g.on(this._element,Un,e=>{g.one(this._element,qn,t=>{this._element===e.target&&this._element===t.target&&(this._config.backdrop!=="static"?this._config.backdrop&&this.hide():this._triggerBackdropTransition())})})}_hideModal(){this._element.style.display="none",this._element.setAttribute("aria-hidden",!0),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._isTransitioning=!1,this._backdrop.hide(()=>{document.body.classList.remove(Va),this._resetAdjustments(),this._scrollBar.reset(),g.trigger(this._element,za)})}_isAnimated(){return this._element.classList.contains("fade")}_triggerBackdropTransition(){if(g.trigger(this._element,Vn).defaultPrevented)return;const e=this._element.scrollHeight>document.documentElement.clientHeight,t=this._element.style.overflowY;t==="hidden"||this._element.classList.contains(fi)||(e||(this._element.style.overflowY="hidden"),this._element.classList.add(fi),this._queueCallback(()=>{this._element.classList.remove(fi),this._queueCallback(()=>{this._element.style.overflowY=t},this._dialog)},this._dialog),this._element.focus())}_adjustDialog(){const e=this._element.scrollHeight>document.documentElement.clientHeight,t=this._scrollBar.getWidth(),a=t>0;if(a&&!e){const l=ae()?"paddingLeft":"paddingRight";this._element.style[l]=`${t}px`}if(!a&&e){const l=ae()?"paddingRight":"paddingLeft";this._element.style[l]=`${t}px`}}_resetAdjustments(){this._element.style.paddingLeft="",this._element.style.paddingRight=""}static jQueryInterface(e,t){return this.each(function(){const a=Fe.getOrCreateInstance(this,e);if(typeof e=="string"){if(a[e]===void 0)throw new TypeError(`No method named "${e}"`);a[e](t)}})}}g.on(document,Qn,'[data-bs-toggle="modal"]',function(i){const e=k.getElementFromSelector(this);["A","AREA"].includes(this.tagName)&&i.preventDefault(),g.one(e,Ha,a=>{a.defaultPrevented||g.one(e,za,()=>{_(this)&&this.focus()})});const t=k.findOne(".modal.show");t&&Fe.getInstance(t).hide(),Fe.getOrCreateInstance(e).toggle(this)}),kt(Fe),ce(Fe);const Ae=".bs.offcanvas",Wa=".data-api",Xn=`load${Ae}${Wa}`,qa="show",Ua="showing",Ga="hiding",Qa=".offcanvas.show",Jn=`show${Ae}`,eo=`shown${Ae}`,to=`hide${Ae}`,Ya=`hidePrevented${Ae}`,Za=`hidden${Ae}`,io=`resize${Ae}`,ao=`click${Ae}${Wa}`,so=`keydown.dismiss${Ae}`,no={backdrop:!0,keyboard:!0,scroll:!1},oo={backdrop:"(boolean|string)",keyboard:"boolean",scroll:"boolean"};class Ee extends ve{constructor(e,t){super(e,t),this._isShown=!1,this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._addEventListeners()}static get Default(){return no}static get DefaultType(){return oo}static get NAME(){return"offcanvas"}toggle(e){return this._isShown?this.hide():this.show(e)}show(e){this._isShown||g.trigger(this._element,Jn,{relatedTarget:e}).defaultPrevented||(this._isShown=!0,this._backdrop.show(),this._config.scroll||new vi().hide(),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.classList.add(Ua),this._queueCallback(()=>{this._config.scroll&&!this._config.backdrop||this._focustrap.activate(),this._element.classList.add(qa),this._element.classList.remove(Ua),g.trigger(this._element,eo,{relatedTarget:e})},this._element,!0))}hide(){this._isShown&&(g.trigger(this._element,to).defaultPrevented||(this._focustrap.deactivate(),this._element.blur(),this._isShown=!1,this._element.classList.add(Ga),this._backdrop.hide(),this._queueCallback(()=>{this._element.classList.remove(qa,Ga),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._config.scroll||new vi().reset(),g.trigger(this._element,Za)},this._element,!0)))}dispose(){this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}_initializeBackDrop(){const e=!!this._config.backdrop;return new La({className:"offcanvas-backdrop",isVisible:e,isAnimated:!0,rootElement:this._element.parentNode,clickCallback:e?()=>{this._config.backdrop!=="static"?this.hide():g.trigger(this._element,Ya)}:null})}_initializeFocusTrap(){return new Ma({trapElement:this._element})}_addEventListeners(){g.on(this._element,so,e=>{e.key==="Escape"&&(this._config.keyboard?this.hide():g.trigger(this._element,Ya))})}static jQueryInterface(e){return this.each(function(){const t=Ee.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e](this)}})}}g.on(document,ao,'[data-bs-toggle="offcanvas"]',function(i){const e=k.getElementFromSelector(this);if(["A","AREA"].includes(this.tagName)&&i.preventDefault(),O(this))return;g.one(e,Za,()=>{_(this)&&this.focus()});const t=k.findOne(Qa);t&&t!==e&&Ee.getInstance(t).hide(),Ee.getOrCreateInstance(e).toggle(this)}),g.on(window,Xn,()=>{for(const i of k.find(Qa))Ee.getOrCreateInstance(i).show()}),g.on(window,io,()=>{for(const i of k.find("[aria-modal][class*=show][class*=offcanvas-]"))getComputedStyle(i).position!=="fixed"&&Ee.getOrCreateInstance(i).hide()}),kt(Ee),ce(Ee);const Xa={"*":["class","dir","id","lang","role",/^aria-[\w-]*$/i],a:["target","href","title","rel"],area:[],b:[],br:[],col:[],code:[],dd:[],div:[],dl:[],dt:[],em:[],hr:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],i:[],img:["src","srcset","alt","title","width","height"],li:[],ol:[],p:[],pre:[],s:[],small:[],span:[],sub:[],sup:[],strong:[],u:[],ul:[]},ro=new Set(["background","cite","href","itemtype","longdesc","poster","src","xlink:href"]),lo=/^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,co=(i,e)=>{const t=i.nodeName.toLowerCase();return e.includes(t)?!ro.has(t)||!!lo.test(i.nodeValue):e.filter(a=>a instanceof RegExp).some(a=>a.test(t))},po={allowList:Xa,content:{},extraClass:"",html:!1,sanitize:!0,sanitizeFn:null,template:"<div></div>"},uo={allowList:"object",content:"object",extraClass:"(string|function)",html:"boolean",sanitize:"boolean",sanitizeFn:"(null|function)",template:"string"},ho={entry:"(string|element|function|null)",selector:"(string|element)"};class mo extends ct{constructor(e){super(),this._config=this._getConfig(e)}static get Default(){return po}static get DefaultType(){return uo}static get NAME(){return"TemplateFactory"}getContent(){return Object.values(this._config.content).map(e=>this._resolvePossibleFunction(e)).filter(Boolean)}hasContent(){return this.getContent().length>0}changeContent(e){return this._checkContent(e),this._config.content={...this._config.content,...e},this}toHtml(){const e=document.createElement("div");e.innerHTML=this._maybeSanitize(this._config.template);for(const[l,c]of Object.entries(this._config.content))this._setContent(e,c,l);const t=e.children[0],a=this._resolvePossibleFunction(this._config.extraClass);return a&&t.classList.add(...a.split(" ")),t}_typeCheckConfig(e){super._typeCheckConfig(e),this._checkContent(e.content)}_checkContent(e){for(const[t,a]of Object.entries(e))super._typeCheckConfig({selector:t,entry:a},ho)}_setContent(e,t,a){const l=k.findOne(a,e);l&&((t=this._resolvePossibleFunction(t))?C(t)?this._putElementInTemplate(L(t),l):this._config.html?l.innerHTML=this._maybeSanitize(t):l.textContent=t:l.remove())}_maybeSanitize(e){return this._config.sanitize?function(t,a,l){if(!t.length)return t;if(l&&typeof l=="function")return l(t);const c=new window.DOMParser().parseFromString(t,"text/html"),p=[].concat(...c.body.querySelectorAll("*"));for(const m of p){const v=m.nodeName.toLowerCase();if(!Object.keys(a).includes(v)){m.remove();continue}const y=[].concat(...m.attributes),w=[].concat(a["*"]||[],a[v]||[]);for(const f of y)co(f,w)||m.removeAttribute(f.nodeName)}return c.body.innerHTML}(e,this._config.allowList,this._config.sanitizeFn):e}_resolvePossibleFunction(e){return se(e,[void 0,this])}_putElementInTemplate(e,t){if(this._config.html)return t.innerHTML="",void t.append(e);t.textContent=e.textContent}}const go=new Set(["sanitize","allowList","sanitizeFn"]),bi="fade",Nt="show",vo=".tooltip-inner",Ja=".modal",es="hide.bs.modal",ft="hover",yi="focus",wi="click",fo={AUTO:"auto",TOP:"top",RIGHT:ae()?"left":"right",BOTTOM:"bottom",LEFT:ae()?"right":"left"},bo={allowList:Xa,animation:!0,boundary:"clippingParents",container:!1,customClass:"",delay:0,fallbackPlacements:["top","right","bottom","left"],html:!1,offset:[0,6],placement:"top",popperConfig:null,sanitize:!0,sanitizeFn:null,selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',title:"",trigger:"hover focus"},yo={allowList:"object",animation:"boolean",boundary:"(string|element)",container:"(string|element|boolean)",customClass:"(string|function)",delay:"(number|object)",fallbackPlacements:"array",html:"boolean",offset:"(array|string|function)",placement:"(string|function)",popperConfig:"(null|object|function)",sanitize:"boolean",sanitizeFn:"(null|function)",selector:"(string|boolean)",template:"string",title:"(string|element|function)",trigger:"string"};class Re extends ve{constructor(e,t){if(Aa===void 0)throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org/docs/v2/)");super(e,t),this._isEnabled=!0,this._timeout=0,this._isHovered=null,this._activeTrigger={},this._popper=null,this._templateFactory=null,this._newContent=null,this.tip=null,this._setListeners(),this._config.selector||this._fixTitle()}static get Default(){return bo}static get DefaultType(){return yo}static get NAME(){return"tooltip"}enable(){this._isEnabled=!0}disable(){this._isEnabled=!1}toggleEnabled(){this._isEnabled=!this._isEnabled}toggle(){this._isEnabled&&(this._isShown()?this._leave():this._enter())}dispose(){clearTimeout(this._timeout),g.off(this._element.closest(Ja),es,this._hideModalHandler),this._element.getAttribute("data-bs-original-title")&&this._element.setAttribute("title",this._element.getAttribute("data-bs-original-title")),this._disposePopper(),super.dispose()}show(){if(this._element.style.display==="none")throw new Error("Please use show on visible elements");if(!this._isWithContent()||!this._isEnabled)return;const e=g.trigger(this._element,this.constructor.eventName("show")),t=(V(this._element)||this._element.ownerDocument.documentElement).contains(this._element);if(e.defaultPrevented||!t)return;this._disposePopper();const a=this._getTipElement();this._element.setAttribute("aria-describedby",a.getAttribute("id"));const{container:l}=this._config;if(this._element.ownerDocument.documentElement.contains(this.tip)||(l.append(a),g.trigger(this._element,this.constructor.eventName("inserted"))),this._popper=this._createPopper(a),a.classList.add(Nt),"ontouchstart"in document.documentElement)for(const c of[].concat(...document.body.children))g.on(c,"mouseover",G);this._queueCallback(()=>{g.trigger(this._element,this.constructor.eventName("shown")),this._isHovered===!1&&this._leave(),this._isHovered=!1},this.tip,this._isAnimated())}hide(){if(this._isShown()&&!g.trigger(this._element,this.constructor.eventName("hide")).defaultPrevented){if(this._getTipElement().classList.remove(Nt),"ontouchstart"in document.documentElement)for(const e of[].concat(...document.body.children))g.off(e,"mouseover",G);this._activeTrigger[wi]=!1,this._activeTrigger[yi]=!1,this._activeTrigger[ft]=!1,this._isHovered=null,this._queueCallback(()=>{this._isWithActiveTrigger()||(this._isHovered||this._disposePopper(),this._element.removeAttribute("aria-describedby"),g.trigger(this._element,this.constructor.eventName("hidden")))},this.tip,this._isAnimated())}}update(){this._popper&&this._popper.update()}_isWithContent(){return!!this._getTitle()}_getTipElement(){return this.tip||(this.tip=this._createTipElement(this._newContent||this._getContentForTemplate())),this.tip}_createTipElement(e){const t=this._getTemplateFactory(e).toHtml();if(!t)return null;t.classList.remove(bi,Nt),t.classList.add(`bs-${this.constructor.NAME}-auto`);const a=(l=>{do l+=Math.floor(1e6*Math.random());while(document.getElementById(l));return l})(this.constructor.NAME).toString();return t.setAttribute("id",a),this._isAnimated()&&t.classList.add(bi),t}setContent(e){this._newContent=e,this._isShown()&&(this._disposePopper(),this.show())}_getTemplateFactory(e){return this._templateFactory?this._templateFactory.changeContent(e):this._templateFactory=new mo({...this._config,content:e,extraClass:this._resolvePossibleFunction(this._config.customClass)}),this._templateFactory}_getContentForTemplate(){return{[vo]:this._getTitle()}}_getTitle(){return this._resolvePossibleFunction(this._config.title)||this._element.getAttribute("data-bs-original-title")}_initializeOnDelegatedTarget(e){return this.constructor.getOrCreateInstance(e.delegateTarget,this._getDelegateConfig())}_isAnimated(){return this._config.animation||this.tip&&this.tip.classList.contains(bi)}_isShown(){return this.tip&&this.tip.classList.contains(Nt)}_createPopper(e){const t=se(this._config.placement,[this,e,this._element]),a=fo[t.toUpperCase()];return mi(this._element,e,this._getPopperConfig(a))}_getOffset(){const{offset:e}=this._config;return typeof e=="string"?e.split(",").map(t=>Number.parseInt(t,10)):typeof e=="function"?t=>e(t,this._element):e}_resolvePossibleFunction(e){return se(e,[this._element,this._element])}_getPopperConfig(e){const t={placement:e,modifiers:[{name:"flip",options:{fallbackPlacements:this._config.fallbackPlacements}},{name:"offset",options:{offset:this._getOffset()}},{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"arrow",options:{element:`.${this.constructor.NAME}-arrow`}},{name:"preSetPlacement",enabled:!0,phase:"beforeMain",fn:a=>{this._getTipElement().setAttribute("data-popper-placement",a.state.placement)}}]};return{...t,...se(this._config.popperConfig,[void 0,t])}}_setListeners(){const e=this._config.trigger.split(" ");for(const t of e)if(t==="click")g.on(this._element,this.constructor.eventName("click"),this._config.selector,a=>{const l=this._initializeOnDelegatedTarget(a);l._activeTrigger[wi]=!(l._isShown()&&l._activeTrigger[wi]),l.toggle()});else if(t!=="manual"){const a=t===ft?this.constructor.eventName("mouseenter"):this.constructor.eventName("focusin"),l=t===ft?this.constructor.eventName("mouseleave"):this.constructor.eventName("focusout");g.on(this._element,a,this._config.selector,c=>{const p=this._initializeOnDelegatedTarget(c);p._activeTrigger[c.type==="focusin"?yi:ft]=!0,p._enter()}),g.on(this._element,l,this._config.selector,c=>{const p=this._initializeOnDelegatedTarget(c);p._activeTrigger[c.type==="focusout"?yi:ft]=p._element.contains(c.relatedTarget),p._leave()})}this._hideModalHandler=()=>{this._element&&this.hide()},g.on(this._element.closest(Ja),es,this._hideModalHandler)}_fixTitle(){const e=this._element.getAttribute("title");e&&(this._element.getAttribute("aria-label")||this._element.textContent.trim()||this._element.setAttribute("aria-label",e),this._element.setAttribute("data-bs-original-title",e),this._element.removeAttribute("title"))}_enter(){this._isShown()||this._isHovered?this._isHovered=!0:(this._isHovered=!0,this._setTimeout(()=>{this._isHovered&&this.show()},this._config.delay.show))}_leave(){this._isWithActiveTrigger()||(this._isHovered=!1,this._setTimeout(()=>{this._isHovered||this.hide()},this._config.delay.hide))}_setTimeout(e,t){clearTimeout(this._timeout),this._timeout=setTimeout(e,t)}_isWithActiveTrigger(){return Object.values(this._activeTrigger).includes(!0)}_getConfig(e){const t=Ce.getDataAttributes(this._element);for(const a of Object.keys(t))go.has(a)&&delete t[a];return e={...t,...typeof e=="object"&&e?e:{}},e=this._mergeConfigObj(e),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}_configAfterMerge(e){return e.container=e.container===!1?document.body:L(e.container),typeof e.delay=="number"&&(e.delay={show:e.delay,hide:e.delay}),typeof e.title=="number"&&(e.title=e.title.toString()),typeof e.content=="number"&&(e.content=e.content.toString()),e}_getDelegateConfig(){const e={};for(const[t,a]of Object.entries(this._config))this.constructor.Default[t]!==a&&(e[t]=a);return e.selector=!1,e.trigger="manual",e}_disposePopper(){this._popper&&(this._popper.destroy(),this._popper=null),this.tip&&(this.tip.remove(),this.tip=null)}static jQueryInterface(e){return this.each(function(){const t=Re.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0)throw new TypeError(`No method named "${e}"`);t[e]()}})}}ce(Re);const wo=".popover-header",_o=".popover-body",ko={...Re.Default,content:"",offset:[0,8],placement:"right",template:'<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',trigger:"click"},xo={...Re.DefaultType,content:"(null|string|element|function)"};class Mt extends Re{static get Default(){return ko}static get DefaultType(){return xo}static get NAME(){return"popover"}_isWithContent(){return this._getTitle()||this._getContent()}_getContentForTemplate(){return{[wo]:this._getTitle(),[_o]:this._getContent()}}_getContent(){return this._resolvePossibleFunction(this._config.content)}static jQueryInterface(e){return this.each(function(){const t=Mt.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0)throw new TypeError(`No method named "${e}"`);t[e]()}})}}ce(Mt);const _i=".bs.scrollspy",$o=`activate${_i}`,ts=`click${_i}`,Co=`load${_i}.data-api`,nt="active",ki="[href]",is=".nav-link",So=`${is}, .nav-item > ${is}, .list-group-item`,Ao={offset:null,rootMargin:"0px 0px -25%",smoothScroll:!1,target:null,threshold:[.1,.5,1]},Eo={offset:"(number|null)",rootMargin:"string",smoothScroll:"boolean",target:"element",threshold:"array"};class bt extends ve{constructor(e,t){super(e,t),this._targetLinks=new Map,this._observableSections=new Map,this._rootElement=getComputedStyle(this._element).overflowY==="visible"?null:this._element,this._activeTarget=null,this._observer=null,this._previousScrollData={visibleEntryTop:0,parentScrollTop:0},this.refresh()}static get Default(){return Ao}static get DefaultType(){return Eo}static get NAME(){return"scrollspy"}refresh(){this._initializeTargetsAndObservables(),this._maybeEnableSmoothScroll(),this._observer?this._observer.disconnect():this._observer=this._getNewObserver();for(const e of this._observableSections.values())this._observer.observe(e)}dispose(){this._observer.disconnect(),super.dispose()}_configAfterMerge(e){return e.target=L(e.target)||document.body,e.rootMargin=e.offset?`${e.offset}px 0px -30%`:e.rootMargin,typeof e.threshold=="string"&&(e.threshold=e.threshold.split(",").map(t=>Number.parseFloat(t))),e}_maybeEnableSmoothScroll(){this._config.smoothScroll&&(g.off(this._config.target,ts),g.on(this._config.target,ts,ki,e=>{const t=this._observableSections.get(e.target.hash);if(t){e.preventDefault();const a=this._rootElement||window,l=t.offsetTop-this._element.offsetTop;if(a.scrollTo)return void a.scrollTo({top:l,behavior:"smooth"});a.scrollTop=l}}))}_getNewObserver(){const e={root:this._rootElement,threshold:this._config.threshold,rootMargin:this._config.rootMargin};return new IntersectionObserver(t=>this._observerCallback(t),e)}_observerCallback(e){const t=p=>this._targetLinks.get(`#${p.target.id}`),a=p=>{this._previousScrollData.visibleEntryTop=p.target.offsetTop,this._process(t(p))},l=(this._rootElement||document.documentElement).scrollTop,c=l>=this._previousScrollData.parentScrollTop;this._previousScrollData.parentScrollTop=l;for(const p of e){if(!p.isIntersecting){this._activeTarget=null,this._clearActiveClass(t(p));continue}const m=p.target.offsetTop>=this._previousScrollData.visibleEntryTop;if(c&&m){if(a(p),!l)return}else c||m||a(p)}}_initializeTargetsAndObservables(){this._targetLinks=new Map,this._observableSections=new Map;const e=k.find(ki,this._config.target);for(const t of e){if(!t.hash||O(t))continue;const a=k.findOne(decodeURI(t.hash),this._element);_(a)&&(this._targetLinks.set(decodeURI(t.hash),t),this._observableSections.set(t.hash,a))}}_process(e){this._activeTarget!==e&&(this._clearActiveClass(this._config.target),this._activeTarget=e,e.classList.add(nt),this._activateParents(e),g.trigger(this._element,$o,{relatedTarget:e}))}_activateParents(e){if(e.classList.contains("dropdown-item"))k.findOne(".dropdown-toggle",e.closest(".dropdown")).classList.add(nt);else for(const t of k.parents(e,".nav, .list-group"))for(const a of k.prev(t,So))a.classList.add(nt)}_clearActiveClass(e){e.classList.remove(nt);const t=k.find(`${ki}.${nt}`,e);for(const a of t)a.classList.remove(nt)}static jQueryInterface(e){return this.each(function(){const t=bt.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e]()}})}}g.on(window,Co,()=>{for(const i of k.find('[data-bs-spy="scroll"]'))bt.getOrCreateInstance(i)}),ce(bt);const ze=".bs.tab",To=`hide${ze}`,Io=`hidden${ze}`,Oo=`show${ze}`,Do=`shown${ze}`,jo=`click${ze}`,Po=`keydown${ze}`,Lo=`load${ze}`,No="ArrowLeft",as="ArrowRight",Mo="ArrowUp",ss="ArrowDown",xi="Home",ns="End",He="active",os="fade",$i="show",rs=".dropdown-toggle",Ci=`:not(${rs})`,ls='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',Si=`.nav-link${Ci}, .list-group-item${Ci}, [role="tab"]${Ci}, ${ls}`,Bo=`.${He}[data-bs-toggle="tab"], .${He}[data-bs-toggle="pill"], .${He}[data-bs-toggle="list"]`;class Ve extends ve{constructor(e){super(e),this._parent=this._element.closest('.list-group, .nav, [role="tablist"]'),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),g.on(this._element,Po,t=>this._keydown(t)))}static get NAME(){return"tab"}show(){const e=this._element;if(this._elemIsActive(e))return;const t=this._getActiveElem(),a=t?g.trigger(t,To,{relatedTarget:e}):null;g.trigger(e,Oo,{relatedTarget:t}).defaultPrevented||a&&a.defaultPrevented||(this._deactivate(t,e),this._activate(e,t))}_activate(e,t){e&&(e.classList.add(He),this._activate(k.getElementFromSelector(e)),this._queueCallback(()=>{e.getAttribute("role")==="tab"?(e.removeAttribute("tabindex"),e.setAttribute("aria-selected",!0),this._toggleDropDown(e,!0),g.trigger(e,Do,{relatedTarget:t})):e.classList.add($i)},e,e.classList.contains(os)))}_deactivate(e,t){e&&(e.classList.remove(He),e.blur(),this._deactivate(k.getElementFromSelector(e)),this._queueCallback(()=>{e.getAttribute("role")==="tab"?(e.setAttribute("aria-selected",!1),e.setAttribute("tabindex","-1"),this._toggleDropDown(e,!1),g.trigger(e,Io,{relatedTarget:t})):e.classList.remove($i)},e,e.classList.contains(os)))}_keydown(e){if(![No,as,Mo,ss,xi,ns].includes(e.key))return;e.stopPropagation(),e.preventDefault();const t=this._getChildren().filter(l=>!O(l));let a;if([xi,ns].includes(e.key))a=t[e.key===xi?0:t.length-1];else{const l=[as,ss].includes(e.key);a=Kt(t,e.target,l,!0)}a&&(a.focus({preventScroll:!0}),Ve.getOrCreateInstance(a).show())}_getChildren(){return k.find(Si,this._parent)}_getActiveElem(){return this._getChildren().find(e=>this._elemIsActive(e))||null}_setInitialAttributes(e,t){this._setAttributeIfNotExists(e,"role","tablist");for(const a of t)this._setInitialAttributesOnChild(a)}_setInitialAttributesOnChild(e){e=this._getInnerElement(e);const t=this._elemIsActive(e),a=this._getOuterElement(e);e.setAttribute("aria-selected",t),a!==e&&this._setAttributeIfNotExists(a,"role","presentation"),t||e.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(e,"role","tab"),this._setInitialAttributesOnTargetPanel(e)}_setInitialAttributesOnTargetPanel(e){const t=k.getElementFromSelector(e);t&&(this._setAttributeIfNotExists(t,"role","tabpanel"),e.id&&this._setAttributeIfNotExists(t,"aria-labelledby",`${e.id}`))}_toggleDropDown(e,t){const a=this._getOuterElement(e);if(!a.classList.contains("dropdown"))return;const l=(c,p)=>{const m=k.findOne(c,a);m&&m.classList.toggle(p,t)};l(rs,He),l(".dropdown-menu",$i),a.setAttribute("aria-expanded",t)}_setAttributeIfNotExists(e,t,a){e.hasAttribute(t)||e.setAttribute(t,a)}_elemIsActive(e){return e.classList.contains(He)}_getInnerElement(e){return e.matches(Si)?e:k.findOne(Si,e)}_getOuterElement(e){return e.closest(".nav-item, .list-group-item")||e}static jQueryInterface(e){return this.each(function(){const t=Ve.getOrCreateInstance(this);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e]()}})}}g.on(document,jo,ls,function(i){["A","AREA"].includes(this.tagName)&&i.preventDefault(),O(this)||Ve.getOrCreateInstance(this).show()}),g.on(window,Lo,()=>{for(const i of k.find(Bo))Ve.getOrCreateInstance(i)}),ce(Ve);const Oe=".bs.toast",Fo=`mouseover${Oe}`,Ro=`mouseout${Oe}`,zo=`focusin${Oe}`,Ho=`focusout${Oe}`,Vo=`hide${Oe}`,Ko=`hidden${Oe}`,Wo=`show${Oe}`,qo=`shown${Oe}`,cs="hide",Bt="show",Ft="showing",Uo={animation:"boolean",autohide:"boolean",delay:"number"},Go={animation:!0,autohide:!0,delay:5e3};class yt extends ve{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return Go}static get DefaultType(){return Uo}static get NAME(){return"toast"}show(){g.trigger(this._element,Wo).defaultPrevented||(this._clearTimeout(),this._config.animation&&this._element.classList.add("fade"),this._element.classList.remove(cs),X(this._element),this._element.classList.add(Bt,Ft),this._queueCallback(()=>{this._element.classList.remove(Ft),g.trigger(this._element,qo),this._maybeScheduleHide()},this._element,this._config.animation))}hide(){this.isShown()&&(g.trigger(this._element,Vo).defaultPrevented||(this._element.classList.add(Ft),this._queueCallback(()=>{this._element.classList.add(cs),this._element.classList.remove(Ft,Bt),g.trigger(this._element,Ko)},this._element,this._config.animation)))}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(Bt),super.dispose()}isShown(){return this._element.classList.contains(Bt)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout(()=>{this.hide()},this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const a=e.relatedTarget;this._element===a||this._element.contains(a)||this._maybeScheduleHide()}_setListeners(){g.on(this._element,Fo,e=>this._onInteraction(e,!0)),g.on(this._element,Ro,e=>this._onInteraction(e,!1)),g.on(this._element,zo,e=>this._onInteraction(e,!0)),g.on(this._element,Ho,e=>this._onInteraction(e,!1))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each(function(){const t=yt.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0)throw new TypeError(`No method named "${e}"`);t[e](this)}})}}return kt(yt),ce(yt),{Alert:dt,Button:pt,Carousel:Ge,Collapse:Ye,Dropdown:fe,Modal:Fe,Offcanvas:Ee,Popover:Mt,ScrollSpy:bt,Tab:Ve,Toast:yt,Tooltip:Re}})})(sr);const ye={CART:"vf_cart",ORDERS:"vf_orders",CUSTOMERS:"vf_customers",ADMIN_AUTH:"vf_admin_auth",DAILY_SPECIAL:"vf_daily_special_id"},wt={getId(){const s=localStorage.getItem(ye.DAILY_SPECIAL);return s?parseInt(s):20},setId(s){localStorage.setItem(ye.DAILY_SPECIAL,s.toString()),window.dispatchEvent(new CustomEvent("daily-special-updated",{detail:{productId:s}}))}},Z={get(){return JSON.parse(localStorage.getItem(ye.CART)||"[]")},save(s){localStorage.setItem(ye.CART,JSON.stringify(s)),window.dispatchEvent(new CustomEvent("cart-updated",{detail:{cart:s}}))},add(s,n=1){const o=this.get(),d=o.find(h=>h.id===s.id);return d?d.qty+=n:o.push({id:s.id,name:s.name,tamilName:s.tamilName,price:s.price,originalPrice:s.originalPrice,image:s.image,qty:n}),this.save(o),o},remove(s){const n=this.get().filter(o=>o.id!==s);return this.save(n),n},updateQty(s,n){const o=this.get(),d=o.find(h=>h.id===s);return d&&(d.qty=Math.max(1,n)),this.save(o),o},clear(){this.save([])},getCount(){return this.get().reduce((s,n)=>s+n.qty,0)},getSubtotal(){return this.get().reduce((s,n)=>s+n.price*n.qty,0)},getDelivery(){return this.getSubtotal()>=499?0:49},getTotal(){return this.getSubtotal()+this.getDelivery()}},$e={get(){return JSON.parse(localStorage.getItem(ye.ORDERS)||"[]")},save(s){localStorage.setItem(ye.ORDERS,JSON.stringify(s))},create(s,n){const o=this.get(),d={id:"VF-"+Date.now().toString(36).toUpperCase(),customer:s,items:n,subtotal:n.reduce((h,u)=>h+u.price*u.qty,0),delivery:Z.getDelivery(),total:Z.getTotal(),status:"pending",createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return o.unshift(d),this.save(o),_t.addOrUpdate(s,d),Z.clear(),d},updateStatus(s,n){const o=this.get(),d=o.find(h=>h.id===s);return d&&(d.status=n,d.updatedAt=new Date().toISOString()),this.save(o),d},getById(s){return this.get().find(n=>n.id===s)},getTotalRevenue(){return this.get().filter(s=>s.status!=="cancelled").reduce((s,n)=>s+n.total,0)},getRecentOrders(s=5){return this.get().slice(0,s)},getOrdersByStatus(s){return s==="all"?this.get():this.get().filter(n=>n.status===s)}},_t={get(){return JSON.parse(localStorage.getItem(ye.CUSTOMERS)||"[]")},save(s){localStorage.setItem(ye.CUSTOMERS,JSON.stringify(s))},addOrUpdate(s,n){const o=this.get(),d=o.find(h=>h.phone===s.phone);d?(d.name=s.name,d.address=s.address,d.orders.push(n.id),d.totalSpent+=n.total,d.lastOrder=n.createdAt):o.push({id:"CUS-"+Date.now().toString(36).toUpperCase(),name:s.name,phone:s.phone,address:s.address,orders:[n.id],totalSpent:n.total,joinedAt:new Date().toISOString(),lastOrder:n.createdAt}),this.save(o)},getById(s){return this.get().find(n=>n.id===s)},search(s){const n=s.toLowerCase();return this.get().filter(o=>o.name.toLowerCase().includes(n)||o.phone.includes(n)||o.id.toLowerCase().includes(n))}},Vt={CREDENTIALS:{username:"admin",password:"admin123"},login(s,n){return s===this.CREDENTIALS.username&&n===this.CREDENTIALS.password?(localStorage.setItem(ye.ADMIN_AUTH,JSON.stringify({loggedIn:!0,loginTime:Date.now()})),!0):!1},isLoggedIn(){return JSON.parse(localStorage.getItem(ye.ADMIN_AUTH)||"{}").loggedIn===!0},logout(){localStorage.removeItem(ye.ADMIN_AUTH)}};function nr(){if($e.get().length>0)return;const s=[{name:"Priya Shankar",phone:"9876543210",address:"45, Anna Nagar, Chennai - 600040"},{name:"Karthik Vel",phone:"9876543211",address:"12, RS Puram, Coimbatore - 641002"},{name:"Lakshmi Devi",phone:"9876543212",address:"78, Srirangam, Trichy - 620006"},{name:"Ramesh Kumar",phone:"9876543213",address:"23, KK Nagar, Madurai - 625020"},{name:"Meena Ravi",phone:"9876543214",address:"56, Thiruvanmiyur, Chennai - 600041"}],n=["pending","processing","delivered","delivered","delivered"],o=s.map((h,u)=>{const b=[{id:u+1,name:["Karupu Kauvni Kanji","Ulunda Kanji","Sprouted Ragi Kanji","Millet Kanji","Bamboo Kanji"][u],tamilName:"டெமோ",price:[89,79,99,85,119][u],qty:Math.ceil(Math.random()*3)},{id:u+6,name:["Poondu Kanji","Moringa Kanji","Kerala Kanji","Pumpkin Kanji","Quinoa Kanji"][u],tamilName:"டெமோ",price:[75,95,89,79,139][u],qty:Math.ceil(Math.random()*2)}],E=b.reduce((_,O)=>_+O.price*O.qty,0),C=E>=499?0:49;return{id:`VF-DEMO${(u+1).toString().padStart(3,"0")}`,customer:h,items:b,subtotal:E,delivery:C,total:E+C,status:n[u],createdAt:new Date(Date.now()-u*864e5).toISOString(),updatedAt:new Date(Date.now()-u*432e5).toISOString()}});$e.save(o);const d=s.map((h,u)=>({id:`CUS-DEMO${(u+1).toString().padStart(3,"0")}`,name:h.name,phone:h.phone,address:h.address,orders:[o[u].id],totalSpent:o[u].total,joinedAt:new Date(Date.now()-u*1728e5).toISOString(),lastOrder:o[u].createdAt}));_t.save(d)}const Cs={KANJI:{id:"kanji",name:"Kanji Varieties",tamilName:"கஞ்சி வகைகள்",icon:"bowl",count:21,image:"./images/cat_kanji_varieties.jpg",tagline:"Traditional slow-cooked earthenware porridges crafted from 21 ancient grains, millets, and medicinal roots.",badge:"21 Heirloom Varieties",chips:["Clay Pot Cooked","21 Ancient Grains","Zero Chemicals"],accent:"#2D5E3F"},DAILY_SPL:{id:"daily-spl",name:"Daily Special",tamilName:"தினசரி சிறப்பு கஞ்சி",icon:"sparkle",count:1,image:"./images/cat_daily_special.jpg",tagline:"Master chef's sunrise curation brewed fresh each dawn with seasonal wild herbs and pure palm nectar.",badge:"Sunrise Fresh Today",chips:["Sunrise Brew","Seasonal Herbs","Limited Batches"],accent:"#D4A017"},SOLID:{id:"solid-eats",name:"Solid Eats",tamilName:"திட உணவுகள் (பயறுகள் & முட்டை)",icon:"salad",count:2,image:"./images/cat_solid_eats.jpg",tagline:"Nutritious sprouted pulses (முளைகட்டிய பயறுகள்) & farm-fresh boiled egg (அவித்த முட்டை) for vital stamina.",badge:"Sprouts & Boiled Egg",chips:["Sprouts Pulses","Boiled Egg","High Protein"],accent:"#8B4513"}},q=[{id:1,name:"Karupu Kauvni Kanji",tamilName:"கருப்பு கவுணி கஞ்சி",category:"kanji",price:89,originalPrice:120,description:"Ancient black rice porridge, rich in anthocyanins and antioxidants. A royal delicacy from Tamil heritage, slow-cooked to perfection with jaggery and coconut milk.",nutrition:{calories:"185",protein:"4.2g",fiber:"3.1g",iron:"12%",calcium:"8%",vitB:"15%"},rating:4.9,reviews:342,badge:"bestseller",inStock:!0,stock:45,image:"./images/karupu_kauvni_kanji.jpg"},{id:2,name:"Ulunda Kanji",tamilName:"உளுந்த கஞ்சி",category:"kanji",price:79,originalPrice:110,description:"Traditional urad dal porridge, known for its warming properties and rich protein content. Perfect for cold mornings, prepared the authentic Tamil way.",nutrition:{calories:"170",protein:"8.5g",fiber:"2.8g",iron:"15%",calcium:"10%",vitB:"18%"},rating:4.8,reviews:218,badge:"bestseller",inStock:!0,stock:38,image:"./images/ulunda_kanji.jpg"},{id:3,name:"Sprouted Ragi Kanji",tamilName:"முளைகட்டிய ராகி கஞ்சி",category:"kanji",price:99,originalPrice:140,description:"Nutrient-dense sprouted finger millet porridge. Sprouting increases bioavailability of calcium and iron. A superfood from grandmother's kitchen.",nutrition:{calories:"160",protein:"5.8g",fiber:"4.5g",iron:"18%",calcium:"22%",vitB:"20%"},rating:4.9,reviews:456,badge:"bestseller",inStock:!0,stock:52,image:"./images/sprouted_ragi_kanji.jpg"},{id:4,name:"Kulakar Kollu Kanji",tamilName:"குளகர் கொள்ளு கஞ்சி",category:"kanji",price:85,originalPrice:115,description:"Horse gram porridge — a powerful weight-management superfood. Stone-ground and slow-cooked with traditional spices for authentic flavor.",nutrition:{calories:"145",protein:"9.2g",fiber:"5.1g",iron:"20%",calcium:"6%",vitB:"12%"},rating:4.7,reviews:167,badge:null,inStock:!0,stock:30,image:"./images/kollu_kanji.jpg"},{id:5,name:"Moringa Kanji",tamilName:"முருங்கை கஞ்சி",category:"kanji",price:95,originalPrice:130,description:'Drumstick leaf-infused kanji, packed with vitamins and minerals. The "miracle tree" porridge for immunity and vitality.',nutrition:{calories:"135",protein:"6.1g",fiber:"3.8g",iron:"25%",calcium:"15%",vitB:"22%"},rating:4.8,reviews:203,badge:"new",inStock:!0,stock:42,image:"./images/moringa_kanji.jpg"},{id:6,name:"Poondu Kanji",tamilName:"பூண்டு கஞ்சி",category:"kanji",price:75,originalPrice:100,description:"Garlic-infused healing porridge, a traditional remedy for cold and flu. Known for its immunity-boosting and heart-healthy properties.",nutrition:{calories:"155",protein:"3.8g",fiber:"2.5g",iron:"10%",calcium:"5%",vitB:"14%"},rating:4.6,reviews:145,badge:null,inStock:!0,stock:25,image:"./images/poondu_kanji.jpg"},{id:7,name:"Kerala Kanji",tamilName:"கேரளா கஞ்சி",category:"kanji",price:89,originalPrice:125,description:"Inspired by Kerala's traditional rice gruel, enriched with coconut milk and spices. A comforting, wholesome porridge.",nutrition:{calories:"175",protein:"4.0g",fiber:"2.2g",iron:"8%",calcium:"12%",vitB:"10%"},rating:4.7,reviews:178,badge:null,inStock:!0,stock:35,image:"./images/kerala_kanji.jpg"},{id:8,name:"Millet Kanji",tamilName:"சிறுதானிய கஞ்சி",category:"kanji",price:85,originalPrice:120,description:"Multi-millet porridge combining foxtail, barnyard, and little millet. A nutritional powerhouse that fuels your day naturally.",nutrition:{calories:"165",protein:"5.5g",fiber:"4.8g",iron:"16%",calcium:"14%",vitB:"18%"},rating:4.8,reviews:289,badge:"bestseller",inStock:!0,stock:60,image:"./images/millet_kanji.jpg"},{id:9,name:"Pumpkin Kanji",tamilName:"பூசணி கஞ்சி",category:"kanji",price:79,originalPrice:105,description:"Sweet pumpkin porridge with jaggery and cardamom. Rich in beta-carotene, this golden kanji is both delicious and nutritious.",nutrition:{calories:"140",protein:"3.2g",fiber:"3.5g",iron:"8%",calcium:"6%",vitB:"25%"},rating:4.5,reviews:112,badge:null,inStock:!0,stock:28,image:"./images/pumpkin_kanji.jpg"},{id:10,name:"Mashroom Kanji",tamilName:"காளான் கஞ்சி",category:"kanji",price:109,originalPrice:150,description:"Exotic mushroom porridge with earthy flavors. Packed with vitamin D and antioxidants for immune system support.",nutrition:{calories:"130",protein:"7.0g",fiber:"2.8g",iron:"10%",calcium:"4%",vitB:"30%"},rating:4.6,reviews:89,badge:"new",inStock:!0,stock:20,image:"./images/mashroom_kanji.jpg"},{id:11,name:"Wheat Kanji",tamilName:"கோதுமை கஞ்சி",category:"kanji",price:69,originalPrice:95,description:"Wholesome broken wheat porridge, a staple comfort food. Light on the stomach and filling for the soul.",nutrition:{calories:"180",protein:"5.2g",fiber:"4.0g",iron:"12%",calcium:"6%",vitB:"16%"},rating:4.5,reviews:156,badge:null,inStock:!0,stock:50,image:"./images/wheat_kanji.jpg"},{id:12,name:"Bamboo Kanji",tamilName:"மூங்கில் கஞ்சி",category:"kanji",price:119,originalPrice:160,description:"Rare bamboo rice porridge from tribal recipes. A unique delicacy with nutty flavor, harvested once in decades.",nutrition:{calories:"155",protein:"4.8g",fiber:"3.2g",iron:"14%",calcium:"8%",vitB:"12%"},rating:4.9,reviews:67,badge:"bestseller",inStock:!0,stock:15,image:"./images/bamboo_kanji.jpg"},{id:13,name:"Kolakandha",tamilName:"கோலாகண்டா",category:"kanji",price:95,originalPrice:130,description:"Heritage recipe kolakandha — fermented rice porridge with cumin and ginger. A probiotic-rich traditional Tamil drink.",nutrition:{calories:"125",protein:"3.5g",fiber:"2.0g",iron:"8%",calcium:"10%",vitB:"14%"},rating:4.7,reviews:198,badge:null,inStock:!0,stock:40,image:"./images/kolakandha.jpg"},{id:14,name:"Vegetable Kanji",tamilName:"காய்கறி கஞ்சி",category:"kanji",price:85,originalPrice:115,description:"Garden-fresh vegetable porridge with seasonal greens. A rainbow of nutrition in every spoonful.",nutrition:{calories:"120",protein:"4.5g",fiber:"5.2g",iron:"15%",calcium:"12%",vitB:"20%"},rating:4.6,reviews:134,badge:null,inStock:!0,stock:35,image:"./images/vegetable_kanji.jpg"},{id:15,name:"Navar Nava Pire Kanji",tamilName:"நாவர் நவ பிரே கஞ்சி",category:"kanji",price:129,originalPrice:175,description:"Nine-grain traditional porridge combining ancient grains. The ultimate nutrition blend from Siddha medicine traditions.",nutrition:{calories:"190",protein:"7.8g",fiber:"5.5g",iron:"22%",calcium:"18%",vitB:"25%"},rating:4.9,reviews:312,badge:"bestseller",inStock:!0,stock:25,image:"./images/navar_kanji.jpg"},{id:16,name:"Keerai Kanji",tamilName:"கீரை கஞ்சி",category:"kanji",price:79,originalPrice:110,description:"Fresh spinach and amaranth greens porridge. Iron-rich superfood kanji for strength and vitality.",nutrition:{calories:"115",protein:"5.0g",fiber:"4.2g",iron:"28%",calcium:"15%",vitB:"18%"},rating:4.7,reviews:167,badge:null,inStock:!0,stock:32,image:"./images/keerai_kanji.jpg"},{id:17,name:"Quinoa Kanji",tamilName:"கினோவா கஞ்சி",category:"kanji",price:139,originalPrice:190,description:"Modern superfood meets Tamil tradition. Quinoa cooked the kanji way with coconut milk and palm jaggery.",nutrition:{calories:"175",protein:"8.5g",fiber:"4.0g",iron:"15%",calcium:"8%",vitB:"20%"},rating:4.6,reviews:98,badge:"new",inStock:!0,stock:22,image:"./images/quinoa_kanji.jpg"},{id:18,name:"Barli Kanji",tamilName:"பார்லி கஞ்சி",category:"kanji",price:75,originalPrice:100,description:"Cooling barley porridge, perfect for summer. Known for its kidney-friendly properties and soothing taste.",nutrition:{calories:"150",protein:"4.2g",fiber:"6.0g",iron:"10%",calcium:"6%",vitB:"12%"},rating:4.5,reviews:123,badge:null,inStock:!0,stock:40,image:"./images/barli_kanji.jpg"},{id:19,name:"Chola Kanji",tamilName:"சோளக் கஞ்சி",category:"kanji",price:79,originalPrice:105,description:"Sorghum porridge — the drought-resistant supergrain of Tamil Nadu. Gluten-free and packed with energy.",nutrition:{calories:"170",protein:"5.0g",fiber:"3.8g",iron:"14%",calcium:"8%",vitB:"16%"},rating:4.6,reviews:145,badge:null,inStock:!0,stock:38,image:"./images/chola_kanji.jpg"},{id:20,name:"Daily SPL 1",tamilName:"தினசரி சிறப்பு 1",category:"daily-spl",price:99,originalPrice:149,description:"Chef's daily special kanji — a unique blend that changes daily. Today's pick combines seasonal ingredients with traditional recipes.",nutrition:{calories:"165",protein:"6.0g",fiber:"4.0g",iron:"15%",calcium:"10%",vitB:"18%"},rating:4.8,reviews:567,badge:"daily",inStock:!0,stock:100,image:"./images/daily_spl_kanji.jpg"},{id:21,name:"Sprouts Pulses",tamilName:"முளை கட்டிய பருப்புகள்",category:"solid-eats",price:69,originalPrice:95,description:"Fresh multi-sprout bowl with green gram, black gram, and horse gram. Tossed with lime, onion, and curry leaves.",nutrition:{calories:"120",protein:"10.5g",fiber:"6.0g",iron:"18%",calcium:"8%",vitB:"22%"},rating:4.7,reviews:234,badge:null,inStock:!0,stock:45,image:"./images/sprouts_pulses.jpg"},{id:22,name:"Boiled Egg",tamilName:"வேக வைத்த முட்டை",category:"solid-eats",price:29,originalPrice:40,description:"Farm-fresh country eggs, perfectly boiled. Served with a side of spiced salt and pepper. Pure protein power.",nutrition:{calories:"78",protein:"6.3g",fiber:"0g",iron:"5%",calcium:"3%",vitB:"10%"},rating:4.5,reviews:456,badge:null,inStock:!0,stock:80,image:"./images/egg.jpg"},{id:23,name:"Poitha Bath",tamilName:"பொய்த்த பாத்",category:"kanji",price:89,originalPrice:120,description:"Traditional fermented rice bath — a probiotic powerhouse. Left overnight and served cold with raw onion and green chilli.",nutrition:{calories:"145",protein:"3.8g",fiber:"2.0g",iron:"8%",calcium:"12%",vitB:"35%"},rating:4.8,reviews:289,badge:"bestseller",inStock:!0,stock:35,image:"./images/poitha_bath.jpg"}],or=[{id:1,text:"The Sprouted Ragi Kanji takes me back to my grandmother's kitchen in Madurai. Authentic taste, pure ingredients. My whole family starts the day with VedicFueloon!",name:"Priya Shankar",tamilName:"பிரியா சங்கர்",location:"Chennai, Tamil Nadu",rating:5,initial:"P"},{id:2,text:"I've been ordering Karupu Kauvni Kanji for 3 months. My blood sugar levels have improved significantly. This is not just food — it's medicine from nature.",name:"Dr. Ramesh Kumar",tamilName:"டாக்டர் ரமேஷ் குமார்",location:"Coimbatore, Tamil Nadu",rating:5,initial:"R"},{id:3,text:"As a fitness enthusiast, I love the Sprouts Pulses bowl. High protein, clean ingredients, and the taste is absolutely incredible. Best health food brand!",name:"Karthik Vel",tamilName:"கார்த்திக் வேல்",location:"Madurai, Tamil Nadu",rating:5,initial:"K"},{id:4,text:"The Bamboo Kanji is a rare find! I've never tasted anything like it. VedicFueloon brings forgotten Tamil recipes back to our dining table. Absolutely brilliant!",name:"Lakshmi Devi",tamilName:"லட்சுமி தேவி",location:"Trichy, Tamil Nadu",rating:5,initial:"L"}],ks=["linear-gradient(135deg, #2D5E3F 0%, #1B3A2D 100%)","linear-gradient(135deg, #D4A017 0%, #B8880F 100%)","linear-gradient(135deg, #8B4513 0%, #654321 100%)","linear-gradient(135deg, #556B2F 0%, #3B4F1E 100%)","linear-gradient(135deg, #CD853F 0%, #A0522D 100%)","linear-gradient(135deg, #6B8E23 0%, #4F6B1A 100%)","linear-gradient(135deg, #8B7355 0%, #6B5B3E 100%)","linear-gradient(135deg, #2E8B57 0%, #1E6B42 100%)"];function Ss(s){return ks[(s-1)%ks.length]}function As(s){return q.find(n=>n.id===parseInt(s))}function xs(s){return s==="all"?q:s==="daily-spl"?[{...Di(),category:"daily-spl",badge:"daily"}]:s==="kanji"?q.filter(n=>n.category==="kanji"||n.category==="daily-spl"):q.filter(n=>n.category===s)}function Di(){const s=localStorage.getItem("vf_daily_special_id");if(s){const n=q.find(o=>o.id===parseInt(s));if(n)return n}return q.find(n=>n.id===20)||q[0]}const r={leaf:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 17 3.5 19 1c1 2 2 4.5 1 8-1 3.5-3.5 5-7 7"></path><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"></path></svg>',pot:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11h18"></path><path d="M5 11v8a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-8"></path><path d="M12 5v6"></path><path d="M9 3h6"></path></svg>',mortar:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 22h14"></path><path d="M5 22c-1 0-2-1-2-3v-3c0-2 3-3 9-3s9 1 9 3v3c0 2-1 3-2 3"></path><path d="M12 3v10"></path><circle cx="12" cy="3" r="2"></circle></svg>',star:'<svg class="icon-svg" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>',starEmpty:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>',cart:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>',plus:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',heart:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>',search:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',check:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',x:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',alert:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',fire:'<svg class="icon-svg" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 23c-3.87 0-7-3.13-7-7 0-2.38 1.19-4.47 3-5.74V9c0-3.87 3.13-7 7-7a1 1 0 0 1 .71.29c.18.19.29.45.29.71v2.28c1.48 1.45 2.39 3.21 2.68 5.22A5 5 0 0 1 22 15a5 5 0 0 1-5 5h-.06A7 7 0 0 1 12 23zm0-18.93A5 5 0 0 0 8 9v2a1 1 0 0 1-.45.84A5 5 0 0 0 7 16a5 5 0 0 0 5 5 5 5 0 0 0 4.06-2.07A3 3 0 0 0 20 15a3 3 0 0 0-2-2.83 1 1 0 0 1-.68-.93c-.14-1.86-.86-3.44-2.14-4.7A1 1 0 0 1 15 5.8V4.14A5 5 0 0 0 12 4.07z"></path></svg>',sparkle:'<svg class="icon-svg" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 1l2.09 6.26L20 9.27l-4.91 3.82L16.82 20 12 16.77 7.18 20l1.73-6.91L4 9.27l5.91-2.01L12 1z"></path></svg>',handshake:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 17l-5-5-4 4-3-3-5 5"></path><path d="M4 15v4h4"></path><path d="M20 15v4h-4"></path></svg>',phone:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13 1 .37 2.01.72 2.97a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.96.35 1.97.59 2.97.72A2 2 0 0 1 22 16.92z"></path></svg>',settings:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>',realWhatsapp:'<svg class="real-brand-logo real-wa-logo" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="23" fill="#25D366"/><path fill-rule="evenodd" clip-rule="evenodd" d="M24 8.5C15.44 8.5 8.5 15.44 8.5 24c0 3.01.86 5.82 2.35 8.21L9 39l7.02-1.78A15.42 15.42 0 0 0 24 39.5c8.56 0 15.5-6.94 15.5-15.5S32.56 8.5 24 8.5zm7.88 21.25c-.33.93-1.64 1.72-2.7 1.95-.73.16-1.69.29-4.91-1.05-4.1-1.71-6.76-5.88-6.96-6.15-.2-.27-1.65-2.2-1.65-4.19 0-1.99 1.05-2.97 1.42-3.37.37-.4.82-.5 1.09-.5.27 0 .54.01.79.02.26.01.6-.1.95.73.36.86 1.22 2.97 1.32 3.19.1.21.17.47.03.76-.14.29-.22.46-.43.7-.21.24-.44.55-.63.73-.21.22-.44.45-.19.89.26.44 1.15 1.89 2.47 3.07 1.69 1.5 3.13 1.98 3.57 2.19.45.22.7.19.96-.11.26-.3.11-1.29 1.41-1.74.3-.44.6-.37 1.02-.21.42.16 2.64 1.25 3.1 1.48.46.23.76.35.87.55.12.2.12 1.16-.21 2.09z" fill="#FFFFFF"/></svg>',realInstagram:'<svg class="real-brand-logo real-ig-logo" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="realIgRadial" cx="20%" cy="110%" r="95%"><stop offset="0%" stop-color="#FFD521"/><stop offset="25%" stop-color="#FF543E"/><stop offset="65%" stop-color="#C837AB"/><stop offset="100%" stop-color="#3771C8"/></radialGradient></defs><rect width="48" height="48" rx="12" fill="url(#realIgRadial)"/><rect x="9.5" y="9.5" width="29" height="29" rx="8" fill="none" stroke="#FFFFFF" stroke-width="3.2"/><circle cx="24" cy="24" r="7" fill="none" stroke="#FFFFFF" stroke-width="3.2"/><circle cx="31.8" cy="16.2" r="2.2" fill="#FFFFFF"/></svg>',messageCircle:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>',arrowRight:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>',arrowLeft:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>',chevronRight:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>',trash:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>',truck:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>',users:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>',home:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>',logOut:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>',barChart:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="20" x2="12" y2="10"></line><line x1="18" y1="20" x2="18" y2="4"></line><line x1="6" y1="20" x2="6" y2="16"></line></svg>',package:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"></line><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>',bowl:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11h18c0 5.523-4.477 10-10 10H7C4.477 21 2 17.523 3 11z"></path><path d="M7 11c0-4 2-6 5-6s5 2 5 6"></path><line x1="12" y1="3" x2="12" y2="5"></line></svg>',vegCircle:'<svg class="icon-svg" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="#27AE60" stroke-width="2"/><circle cx="12" cy="12" r="5" fill="#27AE60"/></svg>',clipboard:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>',shoppingBag:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>',wheat:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 22 16 8"></path><path d="M3.47 12.53 5 11l1.53 1.53a3.5 3.5 0 0 1 0 4.94L5 19l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"></path><path d="M7.47 8.53 9 7l1.53 1.53a3.5 3.5 0 0 1 0 4.94L9 15l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"></path><path d="M11.47 4.53 13 3l1.53 1.53a3.5 3.5 0 0 1 0 4.94L13 11l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"></path><path d="M20 2h2v2a4 4 0 0 1-4 4h-2V6a4 4 0 0 1 4-4Z"></path><path d="M11.47 17.47 13 19l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L5 19l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"></path><path d="M15.47 13.47 17 15l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L9 15l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"></path><path d="M19.47 9.47 21 11l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L13 11l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"></path></svg>',flask:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6"></path><path d="M10 9V3"></path><path d="M14 9V3"></path><path d="M10 9l-4 11a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2L14 9"></path></svg>',nutrition:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>',edit:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>',diamond:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 12l10 10 10-10L12 2z"></path></svg>',hourglass:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 22h14"></path><path d="M5 2h14"></path><path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22"></path><path d="M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2"></path></svg>',salad:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 21h10"></path><path d="M12 21a9 9 0 0 0 9-9H3a9 9 0 0 0 9 9Z"></path><path d="M11.38 12a2.4 2.4 0 0 1-.4-4.77 2.4 2.4 0 0 1 3.2-2.77 2.4 2.4 0 0 1 3.47-.63 2.4 2.4 0 0 1 3.37 1.44 2.4 2.4 0 0 1-1.02 3.73"></path><path d="M12.62 12a2.4 2.4 0 0 0 .4-4.77 2.4 2.4 0 0 0-3.2-2.77"></path></svg>',list:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>',eco:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 22c1.25-1.25 2.5-2.5 4-3.5C8.5 17 11 16.5 14 17c-1 1-2 2.5-2 4.5"></path><path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 17 3.5 19 1c1 2 2 4.5 1 8-1 3.5-3.5 5-7 7"></path></svg>',lock:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>',eye:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="10" r="3"></circle></svg>',currency:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>',lightning:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',flower:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M12 2a4 4 0 0 0-4 4c0 3 4 6 4 6s4-3 4-6a4 4 0 0 0-4-4z"></path><path d="M12 22a4 4 0 0 0 4-4c0-3-4-6-4-6s-4 3-4 6a4 4 0 0 0 4 4z"></path><path d="M2 12a4 4 0 0 0 4 4c3 0 6-4 6-4s-3-4-6-4a4 4 0 0 0-4 4z"></path><path d="M22 12a4 4 0 0 0-4-4c-3 0-6 4-6 4s3 4 6 4a4 4 0 0 0 4-4z"></path></svg>',checkCircle:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>',shieldCheck:'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><polyline points="9 12 11 14 15 10"></polyline></svg>'};function rr(){const s=Z.getCount();return`
    <div class="announcement-bar">
      <div class="announce-track">
        <span class="announce-item"><span class="announce-icon">${r.sparkle}</span> Free Delivery on orders above ₹499 | இலவச டெலிவரி ₹499 மேல்</span>
  ...
  `}function rt(s){var b;const n=Math.round((1-s.price/s.originalPrice)*100),o=Ss(s.id),d=s.badge?`<span class="badge badge-${s.badge}">${s.badge==="bestseller"?"Best Seller":s.badge==="new"?"New Harvest":s.badge==="daily"?"Daily Special":""}</span>`:"",h=ji(s.rating),u=(b=s.nutrition)!=null&&b.protein?`${s.nutrition.protein} Protein`:"Heritage Recipe";return`
  ...
  `}function ji(s){let n="";for(let o=1;o<=5;o++)o<=Math.floor(s)||o-.5<=s?n+=r.star:n+=`<span class="star-empty">${r.starEmpty}</span>`;return n}function Y(s,n,o="success"){let d=document.getElementById("toastContainer");d||(d=document.createElement("div"),d.id="toastContainer",d.className="toast-container",document.body.appendChild(d));const h={success:r.check,error:r.x,warning:r.alert},u=document.createElement("div");u.className=`toast ${o==="error"?"toast-error":o==="warning"?"toast-warning":""}`,u.innerHTML=`
    <span class="toast-icon">${h[o]||r.check}</span>
  ...
  `,d.appendChild(u),requestAnimationFrame(()=>{u.classList.add("show")}),setTimeout(()=>{u.classList.remove("show"),setTimeout(()=>u.remove(),300)},3500)}function Es(){const s=Z.getCount(),n=document.getElementById("cartCount");n&&(n.textContent=s,s>0&&(n.parentElement.classList.add("cart-bounce"),setTimeout(()=>n.parentElement.classList.remove("cart-bounce"),500)))}function cr(){const s=document.querySelectorAll("h1, h2, h3, .display-heading, .special-title, .cat-title, .comm-banner-title, .comm-channel-title, .product-title, .section-header h2, .section-header h3");function n(o){if(typeof Intl<"u"&&Intl.Segmenter)try{const d=new Intl.Segmenter(void 0,{granularity:"grapheme"});return Array.from(d.segment(o),h=>h.segment)}catch{}return Array.from(o)}s.forEach(o=>{if(o.closest(".modal, .announcement-bar, .admin-sidebar, .admin-layout, .toast, .navbar, .product-card")||(o.classList.add("split-heading","heading-rise"),o.dataset.split==="done"))return;o.dataset.split="done";let d=0;function h(b){var E;if(b.nodeType===Node.TEXT_NODE){const C=b.textContent;if(!C)return null;const L=document.createDocumentFragment();return C.split(/(\s+)/).forEach(O=>{if(O)if(/^\s+$/.test(O)){const V=document.createElement("span");V.className="split-space",V.innerHTML="&nbsp;",L.appendChild(V)}else{const V=document.createElement("span");V.className="split-word",n(O).forEach(X=>{const Q=document.createElement("span");Q.className="split-char",Q.style.setProperty("--char-idx",d++),Q.textContent=X,V.appendChild(Q)}),L.appendChild(V)}}),L}else if(b.nodeType===Node.ELEMENT_NODE){const C=b.tagName.toLowerCase();if(C==="br"||C==="svg"||C==="path"||C==="circle"||C==="polygon"||C==="rect"||C==="line"||C==="polyline"||(E=b.classList)!=null&&E.contains("icon-svg"))return b.cloneNode(!0);const L=b.cloneNode(!1);return b.childNodes.forEach(_=>{const O=h(_);O&&L.appendChild(O)}),L}return b.cloneNode(!0)}const u=document.createDocumentFragment();Array.from(o.childNodes).forEach(b=>{const E=h(b);E&&u.appendChild(E)}),u.childNodes.length>0&&(o.innerHTML="",o.appendChild(u))})}function Ts(){window._vfScrollObserver&&window._vfScrollObserver.disconnect(),cr(),document.querySelectorAll("section:not(.hero)").forEach(o=>{o.classList.contains("section-scroll-blur")||o.classList.add("section-scroll-blur")});const s=new IntersectionObserver(o=>{o.forEach(d=>{d.isIntersecting?d.target.classList.add("visible"):d.target.classList.remove("visible")})},{threshold:.08,rootMargin:"0px 0px -30px 0px"});window._vfScrollObserver=s,document.querySelectorAll(".split-heading, .heading-rise, .section-header, .reveal, .reveal-stagger, .reveal-left, .reveal-right, .reveal-scale, .section-animate, .section-scroll-blur").forEach(o=>{o.closest(".modal, .announcement-bar, .admin-sidebar, .admin-layout, .toast, .navbar, .product-card")||s.observe(o)})}function dr(s){document.querySelectorAll(".nav-link").forEach(n=>{n.classList.toggle("active",n.dataset.page===s)})}function H(s){return"₹"+s.toLocaleString("en-IN")}function lt(s){return new Date(s).toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}function pr(){const s=q.filter(d=>d.badge==="bestseller"),n=q.filter(d=>d.badge==="new"),o=Di();return`
    <!-- Hero Section -->
          ...
          <div class="hero-text">
            ...
            <div class="hero-actions">
              ...
              <a href="#/about" class="btn btn-ghost btn-lg btn-ripple">
                Explore Our Story ${r.arrowRight}
              </a>
            </div>
          </div>
    ...
    <section class="section section-cream kolam-bg section-scroll-blur" id="categoriesSection">
      <div class="container">
        ...
        <div class="grid-3 reveal-stagger">
          ${Object.values(Cs).map(d=>{const h=d.id==="daily-spl",u=h&&o.image||d.image,b=h?`Daily Special: ${o.name}`:d.name,E=h?o.tamilName:d.tamilName,C=h?`Today's Sunrise Curation: Freshly brewed ${o.name} with authentic heirloom herbs. Limited morning batches!`:d.tagline;return`
            <div class="category-card tilt-hover" onclick="location.hash='#/shop?category=${d.id}'">
              <!-- Food Image with slow zoom -->
              <div class="cat-image-wrap">
                <img src="${u}" alt="${b}" class="cat-image" loading="lazy" />
              ...
              <div class="cat-top-bar">
                <span class="cat-badge-pill">
                  ${d.id==="kanji"?r.pot:h?r.sparkle:r.salad}
                  ${h?"Today's Special":d.badge}
                </span>
                <span class="cat-count-pill">${d.count} ITEMS</span>
              </div>

              <!-- Content Overlay -->
              <div class="cat-content">
                <div class="cat-tamil tamil-text">${E}</div>
                <h3 class="cat-title">${b}</h3>
                <p class="cat-desc">${C}</p>
                ...
                `:`
                  ...
                  <div class="cat-chips">
                    ${(d.chips||[]).map(L=>`<span class="cat-chip">${r.sparkle} ${L}</span>`).join("")}
                  </div>
                `}
        ...
        <div class="solid-eats-spotlight reveal" style="margin-top: var(--space-8); background: white; border: 1.5px solid rgba(212, 160, 23, 0.28); border-radius: var(--radius-2xl); padding: var(--space-6) var(--space-8); box-shadow: 0 10px 28px rgba(0,0,0,0.06);">
          <div style="display:flex; justify-content:space-between; align-items:flex-end; flex-wrap:wrap; gap:var(--space-4); margin-bottom: var(--space-6);">
            <div>
              <span class="section-badge">${r.salad} SOLID EATS SPOTLIGHT (திட உணவுகள்)</span>
            ...
            <a href="#/shop?category=solid-eats" class="btn btn-outline btn-sm btn-ripple">
              View Solid Eats Menu ${r.arrowRight}
            </a>
          </div>

          <div class="grid-2 reveal-stagger">
            ${q.filter(d=>d.category==="solid-eats").map(d=>rt(d)).join("")}
          </div>
        </div>
        ...
        <div class="grid-2 reveal-stagger" style="max-width:900px; margin:0 auto;">
          ${or.map(d=>`
            <div class="testimonial-card hover-lift">
              <p class="test-text">${d.text}</p>
              <div class="test-author">
                <div class="test-avatar">${d.initial}</div>
                <div>
                  <div class="test-name">${d.name}</div>
                  <div class="test-location">${d.location}</div>
                  <div class="test-stars">${ji(d.rating)}</div>
                </div>
              </div>
            </div>
          `).join("")}
      ...
      <div class="container text-center section-animate">
        ...
        <div style="display:flex; gap:var(--space-4); justify-content:center; flex-wrap:wrap; align-items:center;">
          ...
          <a href="https://wa.me/919876543210?text=Hi!%20I%20would%20like%20to%20order%20from%20VedicFueloon" target="_blank" rel="noopener" class="btn btn-ghost btn-lg btn-ripple" style="display:inline-flex; align-items:center; gap:8px;">
            <span style="width:24px; height:24px; display:inline-block;">${r.realWhatsapp}</span> WhatsApp Order
          </a>
    ...
    <a href="https://wa.me/919876543210?text=Hi!%20I%20would%20like%20to%20order%20from%20VedicFueloon" target="_blank" rel="noopener" class="floating-wa-btn" title="Chat with us on WhatsApp" aria-label="WhatsApp Quick Order">
      ...
      <span style="width:32px; height:32px; display:inline-block;">${r.realWhatsapp}</span>
    </a>
  `}function ur(){const s=document.getElementById("heroLogoVideo")||document.querySelector(".hero-logo-video");if(!s)return;window._heroVideoInterval&&(clearInterval(window._heroVideoInterval),window._heroVideoInterval=null);const n=()=>{s.currentTime=0;const o=s.play();o!==void 0&&o.catch(()=>{})};n(),window._heroVideoInterval=setInterval(()=>{if(!document.body.contains(s)){clearInterval(window._heroVideoInterval),window._heroVideoInterval=null;return}n()},1e4),s.style.cursor="pointer",s.onclick=()=>{n()}}function hr(s={}){const n=s.category||"all",o=xs(n),d=[{id:"all",name:"All Items",tamilName:"அனைத்தும்",count:q.length},...Object.values(Cs).map(u=>({...u,count:xs(u.id).length}))],h={all:r.list,kanji:r.bowl,"daily-spl":r.sparkle,"solid-eats":r.salad};return`
  ...
  `}function mr(){window.shopSort=function(s){const n=document.getElementById("productsGrid");if(!n)return;const o=[...n.querySelectorAll(".product-card")],d=b=>{const E=b.querySelector(".card-price").textContent;return parseInt(E.replace(/[^\d]/g,""))},h=b=>{var C;const E=((C=b.querySelector(".card-rating strong"))==null?void 0:C.textContent)||"0";return parseFloat(E)},u=b=>{var E;return((E=b.querySelector(".card-title"))==null?void 0:E.textContent)||""};o.sort((b,E)=>{switch(s){case"price-low":return d(b)-d(E);case"price-high":return d(E)-d(b);case"rating":return h(E)-h(b);case"name":return u(b).localeCompare(u(E));default:return 0}}),o.forEach(b=>n.appendChild(b))},window.shopSearch=function(s){const n=document.getElementById("productsGrid"),o=document.getElementById("noResults"),d=document.getElementById("productCount");if(!n)return;const h=s.toLowerCase();let u=0;n.querySelectorAll(".product-card").forEach(b=>{var O,V,G;const E=((O=b.querySelector(".card-title"))==null?void 0:O.textContent.toLowerCase())||"",C=((V=b.querySelector(".card-tamil-name"))==null?void 0:V.textContent)||"",L=((G=b.querySelector(".card-desc"))==null?void 0:G.textContent.toLowerCase())||"",_=!h||E.includes(h)||C.includes(h)||L.includes(h);b.style.display=_?"":"none",_&&u++}),d&&(d.textContent=u),o&&o.classList.toggle("hidden",u>0)},window.shopPriceFilter=function(s){const n=document.getElementById("productsGrid"),o=document.getElementById("productCount"),d=document.getElementById("priceRangeVal");if(!n)return;d&&(d.textContent=`₹${s}`);let h=0;n.querySelectorAll(".product-card").forEach(u=>{const E=parseInt(u.querySelector(".card-price").textContent.replace(/[^\d]/g,""))<=parseInt(s);u.style.display=E?"":"none",E&&h++}),o&&(o.textContent=h)}}function gr(s){const n=As(s);if(!n)return`
    ...
    `;const o=Math.round((1-n.price/n.originalPrice)*100),d=q.filter(u=>u.category==="kanji"||u.category==="daily-spl"),h=Ss(n.id);return`
    <section class="section product-detail-page">
      <div class="container">
        ...
        <div class="product-detail reveal">
          <div class="product-image-main" style="background: ${h};">
  ...
  `}function vr(){window.updateDetailQty=function(s){const n=document.getElementById("detailQty");if(n){const o=Math.max(1,parseInt(n.value)+s);n.value=o}}}function fr(){const s=Z.get();if(s.length===0)return`
    ...
    `;const n=Z.getSubtotal(),o=Z.getDelivery(),d=Z.getTotal(),h=s.reduce((u,b)=>u+(b.originalPrice-b.price)*b.qty,0);return`
    <section class="section" style="padding-top: var(--space-8);">
      <div class="container">
        ...
        <div class="cart-layout">
          ...
          <div class="cart-summary reveal">
            ...
            <div class="summary-row">
              <span>Delivery</span>
              <span>${o===0?`<span class="free-badge">FREE ${r.check}</span>`:H(o)}</span>
            </div>
  ...
  `}function br(){window.updateCartQty=function(s,n){if(n<1){window.removeCartItem(s);return}Z.updateQty(s,n),window.navigateTo(location.hash)},window.removeCartItem=function(s){Z.remove(s),window.navigateTo(location.hash),window.showToastGlobal("Removed","Item removed from cart","warning")}}function yr(){const s=Z.get();if(s.length===0)return`
    ...
    `;const n=Z.getSubtotal(),o=Z.getDelivery(),d=Z.getTotal();return`
    <section class="section" style="padding-top: var(--space-8);">
      <div class="container">
        <div class="section-header reveal">
          <h1>Checkout</h1>
            ...
            ${s.map(h=>`
              <div style="display:flex; justify-content:space-between; align-items:center; padding:var(--space-3) 0; border-bottom:1px solid var(--cream-100);">
                <div style="display:flex; align-items:center; gap:var(--space-3);">
                  ${h.image?`<img src="${h.image}" alt="${h.name}" style="width:40px;height:40px;object-fit:cover;border-radius:var(--radius-md);flex-shrink:0;" />`:""}
                  <div>
                    <div style="font-weight:600; font-size:var(--text-sm);">${h.name}</div>
                    <div style="font-size:var(--text-xs); color:var(--neutral-400);">Qty: ${h.qty}</div>
                  </div>
                </div>
                <div style="font-weight:600;">${H(h.price*h.qty)}</div>
              </div>
            `).join("")}
        ...
        <div class="order-confirmation reveal">
          ...
          <div style="background:var(--cream-50); border-radius:var(--radius-xl); padding:var(--space-8); max-width:500px; margin:0 auto; text-align:left; border:1px solid var(--cream-200);">
            ...
            <div style="display:flex; justify-content:space-between; margin-bottom:var(--space-3);">
              ...
              <strong style="color:var(--primary-700); font-size:var(--text-lg);">${H(s.total)}</strong>
            </div>
  ...
  `}function _r(){window.placeOrder=function(){var _,O,V,G,X;const s=(_=document.getElementById("checkoutName"))==null?void 0:_.value.trim(),n=(O=document.getElementById("checkoutPhone"))==null?void 0:O.value.trim(),o=(V=document.getElementById("checkoutAddress"))==null?void 0:V.value.trim(),d=(G=document.getElementById("checkoutEmail"))==null?void 0:G.value.trim(),h=(X=document.getElementById("checkoutNotes"))==null?void 0:X.value.trim(),u=document.getElementById("checkoutError");if(!s||!n||!o){u&&(u.style.display="block");return}const b={name:s,phone:n,address:o,email:d,notes:h},E=Z.get(),C=$e.create(b,E),L=document.getElementById("pageContent");if(L){const{renderOrderConfirmation:Q}={renderOrderConfirmation:wr};L.innerHTML=Q(C),window.scrollTo({top:0,behavior:"smooth"}),window.initReveal&&window.initReveal()}Y("Order Placed!",`Order ${C.id} confirmed`,"success")}}function kr(){return`
    <!-- About Hero -->
  ...
  `}function $r(){window.copyToClipboard=function(s,n){navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(s).then(()=>{Y("Copied!",n||"Copied to clipboard","success")}).catch(()=>{Y("Copied!",s,"info")}):Y("Contact Number",s,"info")},window.sendToWhatsAppComposer=function(){var b,E,C;const s=((b=document.getElementById("waComposerName"))==null?void 0:b.value.trim())||"Valued Patron",n=((E=document.getElementById("waComposerTopic"))==null?void 0:E.value)||"Fresh Kanji Order",o=(C=document.getElementById("waComposerMessage"))==null?void 0:C.value.trim();let d=`Vanakkam VedicFueloon!

*Name:* ${s}
*Topic:* ${n}`;o?d+=`
*Message:* ${o}`:d+=`
*Message:* I would like to order fresh traditional health foods from VedicFueloon.`;const u=`https://wa.me/919876543210?text=${encodeURIComponent(d)}`;Y("Opening WhatsApp","Connecting directly to our WhatsApp support...","success"),window.open(u,"_blank")}}function Cr(){return`
  ...
  `}function Sr(){window.adminLogin=function(){var d,h;const s=(d=document.getElementById("adminUsername"))==null?void 0:d.value.trim(),n=(h=document.getElementById("adminPassword"))==null?void 0:h.value,o=document.getElementById("loginError");Vt.login(s,n)?location.hash="#/admin/dashboard":o&&o.classList.add("show")}}function Ar(){const s=$e.get(),n=_t.get(),o=$e.getTotalRevenue(),d=$e.getRecentOrders(5),h=Di(),u=wt.getId(),b=[];for(let _=6;_>=0;_--){const O=new Date;O.setDate(O.getDate()-_);const V=O.toLocaleDateString("en-IN",{weekday:"short"}),X=s.filter(Q=>new Date(Q.createdAt).toDateString()===O.toDateString()&&Q.status!=="cancelled").reduce((Q,ge)=>Q+ge.total,0);b.push({day:V,revenue:X})}const E=Math.max(...b.map(_=>_.revenue),1),C=s.filter(_=>_.status==="pending").length,L=s.filter(_=>_.status==="processing").length;return`
      ...
      <div class="special-admin-grid">
        ...
        <div class="special-preview-box">
          <div class="special-preview-media">
            <img src="${h.image}" alt="${h.name}" id="adminSpecialImg" />
            <span class="special-preview-price">₹${h.price}</span>
          </div>
          <div class="special-preview-details">
            <span class="special-badge-tag">${r.pot} Active Special</span>
            <h4 id="adminSpecialTitle">${h.name}</h4>
            <div class="tamil-text" id="adminSpecialTamil" style="color:var(--gold-400); font-size:var(--text-sm); font-weight:600;">${h.tamilName}</div>
            <p id="adminSpecialDesc" style="font-size:var(--text-xs); color:var(--cream-300); margin: var(--space-2) 0; line-height:1.5;">${h.description.substring(0,110)}...</p>
            <div style="display:flex; gap:var(--space-4); font-size:var(--text-xs); color:var(--cream-400); margin-top:8px;">
              <span>Stock: <strong style="color:var(--gold-400);">${h.stock} left</strong></span>
              <span>Rating: <strong style="color:var(--gold-400);">⭐ ${h.rating} (${h.reviews})</strong></span>
            </div>
          </div>
        </div>
        ...
        <div class="special-controls-box">
          ...
          <div style="margin-top:var(--space-3);">
            ...
            <div class="quick-pick-pills">
              ${[1,2,3,10,15,20,23].map(_=>{const O=q.find(G=>G.id===_);return O?`
                  <button class="quick-pick-pill ${O.id===u?"active":""}" 
                          onclick="window.quickSelectDailySpecial(${O.id})">
                    <span>${O.name}</span>
                    <span class="pill-price">₹${O.price}</span>
                  </button>
                `:""}).join("")}
            </div>
          </div>
    ...
    <div class="dashboard-grid">
      ...
      <div class="chart-container">
        ...
        <div class="bar-chart">
          ${b.map(_=>`
            <div class="bar">
              <div class="bar-value">${_.revenue>0?H(_.revenue):"-"}</div>
              <div class="bar-fill" style="height: ${Math.max(4,_.revenue/E*160)}px;"></div>
      ...
      <div>
        ...
        <div style="background: var(--warning-light); border: 1px solid var(--warning); border-radius: var(--radius-xl); padding: var(--space-5); margin-bottom: var(--space-6);">
          <div style="display:flex; align-items:center; gap:var(--space-3);">
            ...
            <div>
              <div style="font-weight:700; color:var(--neutral-900);">${C} Pending Order${C>1?"s":""}</div>
        ...
        <div class="chart-container">
          ...
          ${q.filter(_=>_.stock<25).slice(0,5).map(_=>`
            <div style="display:flex; justify-content:space-between; align-items:center; padding:var(--space-3) 0; border-bottom:1px solid var(--cream-100);">
              <div>
  ...
  `}window.previewDailySpecial=function(s){const n=q.find(b=>b.id===parseInt(s));if(!n)return;const o=document.getElementById("adminSpecialImg"),d=document.getElementById("adminSpecialTitle"),h=document.getElementById("adminSpecialTamil"),u=document.getElementById("adminSpecialDesc");o&&(o.src=n.image),d&&(d.textContent=n.name),h&&(h.textContent=n.tamilName),u&&(u.textContent=n.description.substring(0,110)+"...")};window.saveDailySpecial=function(){const s=document.getElementById("adminDailySpecialSelect");if(!s)return;const n=parseInt(s.value);wt.setId(n);const o=q.find(d=>d.id===n);Y("🌟 Daily Special Updated!",`${o?o.name:"Item"} is now live for all users on the store!`,"success"),window.adminNavigate("dashboard")};window.quickSelectDailySpecial=function(s){const n=parseInt(s);wt.setId(n);const o=q.find(d=>d.id===n);Y("🌟 Daily Special Set!",`${o?o.name:"Item"} is now active as today's Daily Special!`,"success"),window.adminNavigate("dashboard")};let je=[...q];function Er(){const s=wt.getId();return`
    <div class="admin-header">
      <div>
        <h1>Products</h1>
          ...
          <tbody>
            ${je.map(n=>`
              <tr data-product-id="${n.id}">
                ...
                <td><strong>${H(n.price)}</strong> <span style="color:var(--neutral-400); text-decoration:line-through; font-size:var(--text-xs);">${H(n.originalPrice)}</span></td>
                <td>${n.stock}</td>
  ...
  `}function Tr(){window.openProductModal=function(s=null){const n=document.getElementById("productModal"),o=document.getElementById("productModalTitle");n&&(s?(o.textContent="Edit Product",document.getElementById("editProductId").value=s.id,document.getElementById("prodName").value=s.name,document.getElementById("prodTamilName").value=s.tamilName,document.getElementById("prodCategory").value=s.category,document.getElementById("prodPrice").value=s.price,document.getElementById("prodOrigPrice").value=s.originalPrice,document.getElementById("prodStock").value=s.stock,document.getElementById("prodDesc").value=s.description):(o.textContent="Add New Product",document.getElementById("editProductId").value="",["prodName","prodTamilName","prodPrice","prodOrigPrice","prodStock","prodDesc"].forEach(d=>{const h=document.getElementById(d);h&&(h.value="")})),n.classList.add("active"))},window.closeProductModal=function(){var s;(s=document.getElementById("productModal"))==null||s.classList.remove("active")},window.editProduct=function(s){const n=je.find(o=>o.id===s);n&&window.openProductModal(n)},window.deleteProduct=function(s){confirm("Are you sure you want to delete this product?")&&(je=je.filter(n=>n.id!==s),window.adminNavigate&&window.adminNavigate("products"),Y("Deleted","Product removed successfully","warning"))},window.saveProduct=function(){var C,L,_,O,V,G,X,Q;const s=(C=document.getElementById("editProductId"))==null?void 0:C.value,n=(L=document.getElementById("prodName"))==null?void 0:L.value.trim(),o=(_=document.getElementById("prodTamilName"))==null?void 0:_.value.trim(),d=(O=document.getElementById("prodCategory"))==null?void 0:O.value,h=parseInt((V=document.getElementById("prodPrice"))==null?void 0:V.value),u=parseInt((G=document.getElementById("prodOrigPrice"))==null?void 0:G.value)||h,b=parseInt((X=document.getElementById("prodStock"))==null?void 0:X.value),E=(Q=document.getElementById("prodDesc"))==null?void 0:Q.value.trim();if(!n||!o||!h||!b){Y("Missing Fields","Please fill in all required fields","error");return}if(s){const ge=je.find(ae=>ae.id===parseInt(s));ge&&Object.assign(ge,{name:n,tamilName:o,category:d,price:h,originalPrice:u,stock:b,description:E}),Y("Updated Successfully",`${n} updated successfully`,"success")}else{const ge={id:Date.now(),name:n,tamilName:o,category:d,price:h,originalPrice:u,description:E,nutrition:{calories:"160",protein:"5g",fiber:"4g",iron:"15%",calcium:"10%",vitB:"15%"},rating:5,reviews:1,badge:"new",inStock:!0,stock:b,image:""};je.unshift(ge),Y("Added Successfully",`${n} added to catalog`,"success")}window.closeProductModal(),window.adminNavigate&&window.adminNavigate("products")},window.adminSearchProducts=function(s){const n=s.toLowerCase();document.querySelectorAll("#adminProductsTable tbody tr").forEach(d=>{const h=d.textContent.toLowerCase();d.style.display=h.includes(n)?"":"none"})},window.setAsDailySpecial=function(s){wt.setId(s);const n=je.find(o=>o.id===s);Y("🌟 Daily Special Set!",`${n?n.name:"Product"} is now active as today's Daily Special!`,"success"),window.adminNavigate&&window.adminNavigate("products")}}function Ir(){const s=$e.get(),n={all:s.length,pending:s.filter(o=>o.status==="pending").length,processing:s.filter(o=>o.status==="processing").length,delivered:s.filter(o=>o.status==="delivered").length,cancelled:s.filter(o=>o.status==="cancelled").length};return`
    <div class="admin-header">
      <div>
        <h1>Orders</h1>
              ...
              <tr data-order-id="${o.id}" data-status="${o.status}">
                ...
                <td>
                  <div style="font-size:var(--text-sm);">
                    ${o.items.map(d=>`${d.name} ×${d.qty}`).join("<br/>")}
                  </div>
                </td>
                <td><strong>${H(o.total)}</strong></td>
                <td>
  ...
  `}function Or(){window.updateOrderStatus=function(s,n){$e.updateStatus(s,n),Y("Status Updated",`Order ${s} → ${n}`,"success")},window.filterAdminOrders=function(s,n){document.querySelectorAll("#adminOrdersTable tbody tr").forEach(d=>{s==="all"?d.style.display="":d.style.display=d.dataset.status===s?"":"none"}),document.querySelectorAll(".tabs .tab-btn").forEach(d=>d.classList.remove("active")),n&&n.classList.add("active")},window.adminSearchOrders=function(s){const n=s.toLowerCase();document.querySelectorAll("#adminOrdersTable tbody tr").forEach(o=>{o.style.display=o.textContent.toLowerCase().includes(n)?"":"none"})},window.viewOrderDetail=function(s){var d;const n=$e.getById(s);if(!n)return;const o=document.getElementById("orderDetailContent");o&&(o.innerHTML=`
      ...
      `),(d=document.getElementById("orderDetailModal"))==null||d.classList.add("active")}}function Dr(){const s=_t.get();return`
    <div class="admin-header">
      <div>
        <h1>Customers</h1>
          ...
          <tbody>
            ${s.length>0?s.map(n=>`
              <tr>
                ...
                <td><strong style="color:var(--primary-700);">${H(n.totalSpent)}</strong></td>
  ...
  `}function jr(){window.adminSearchCustomers=function(s){const n=s.toLowerCase();document.querySelectorAll("#adminCustomersTable tbody tr").forEach(o=>{o.style.display=o.textContent.toLowerCase().includes(n)?"":"none"})},window.viewCustomerDetail=function(s){var h;const n=_t.getById(s);if(!n)return;const o=n.orders.map(u=>$e.getById(u)).filter(Boolean),d=document.getElementById("customerDetailContent");d&&(d.innerHTML=`
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:var(--space-4); margin-bottom:var(--space-6);">
          ...
          <div style="background:var(--cream-50); padding:var(--space-4); border-radius:var(--radius-md);">
            ...
            <div style="font-weight:700; color:var(--primary-700); font-size:var(--text-lg);">${H(n.totalSpent)}</div>
          </div>
        ...
        ${o.length>0?o.map(u=>`
          <div style="display:flex; justify-content:space-between; align-items:center; padding:var(--space-3); border-bottom:1px solid var(--cream-100);">
            ...
            <div style="text-align:right;">
              <div style="font-weight:600;">${H(u.total)}</div>
      ...
      `),(h=document.getElementById("customerDetailModal"))==null||h.classList.add("active")}}const Ii=document.getElementById("app");function Pr(s){const n=s.replace("#","")||"/",[o,d]=n.split("?"),h={};return d&&d.split("&").forEach(u=>{const[b,E]=u.split("=");h[b]=decodeURIComponent(E)}),{path:o,params:h}}function Oi(){const{path:s,params:n}=Pr(location.hash);if(s.startsWith("/admin")){Lr(s);return}let o="",d="";switch(!0){case(s==="/"||s===""):o=pr(),d="home";break;case(s==="/shop"||s==="/products"||s==="/kanji"||s==="/menu"):o=hr(n),d="shop";break;case s.startsWith("/product/"):const h=s.split("/")[2];o=gr(h),d="shop";break;case s==="/cart":o=fr(),d="cart";break;case s==="/checkout":o=yr(),d="checkout";break;case s==="/about":o=kr(),d="about";break;case s==="/contact":o=xr(),d="contact";break;default:o=`
        <section class="section">
          <div class="container">
            <div class="empty-state">
              <div class="empty-icon" style="color: var(--neutral-400);">${r.search}</div>
    ...
    ${lr()}
  `,dr(d),Ts(),Nr(),Mr(),d==="home"?ur():window._heroVideoInterval&&(clearInterval(window._heroVideoInterval),window._heroVideoInterval=null),window.scrollTo({top:0,behavior:"instant"})}function Lr(s,n){if(s==="/admin"||s==="/admin/login"){if(Vt.isLoggedIn()){location.hash="#/admin/dashboard";return}Ii.innerHTML=Cr();return}if(!Vt.isLoggedIn()){location.hash="#/admin/login";return}let o="",d="";switch(s){case"/admin/dashboard":o=Ar(),d="dashboard";break;case"/admin/products":o=Er(),d="products";break;case"/admin/orders":o=Ir(),d="orders";break;case"/admin/customers":o=Dr(),d="customers";break;default:location.hash="#/admin/dashboard";return}Ii.innerHTML=`
    <div class="admin-layout">
      <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
          <button class="admin-nav-item ${d==="dashboard"?"active":""}" onclick="window.adminNavigate('dashboard')">
            <span class="nav-icon">${r.barChart}</span> Dashboard
          </button>
          <button class="admin-nav-item ${d==="products"?"active":""}" onclick="window.adminNavigate('products')">
            <span class="nav-icon">${r.bowl}</span> Products
          </button>
          <button class="admin-nav-item ${d==="orders"?"active":""}" onclick="window.adminNavigate('orders')">
            <span class="nav-icon">${r.package}</span> Orders
          </button>
          <button class="admin-nav-item ${d==="customers"?"active":""}" onclick="window.adminNavigate('customers')">
  ...
  `}window.adminNavigate=function(s){location.hash=`#/admin/${s}`};window.adminLogout=function(){Vt.logout(),location.hash="#/admin/login",Y("Logged Out","See you soon!","success")};window.navigateTo=function(s){Oi()};window.addToCart=function(s,n=1){const o=As(s);o&&(Z.add(o,n),Es(),Y("Added to Cart!",`${o.name} × ${n}`,"success"))};window.showToastGlobal=Y;window.initReveal=Ts;function Nr(){const s=document.getElementById("mobileToggle"),n=document.getElementById("navLinks");if(s&&n){const o=()=>{s.classList.remove("active"),s.setAttribute("aria-expanded","false"),n.classList.remove("mobile-open")};s.addEventListener("click",d=>{d.stopPropagation();const h=s.classList.toggle("active");s.setAttribute("aria-expanded",h?"true":"false"),n.classList.toggle("mobile-open",h)}),n.querySelectorAll(".nav-link").forEach(d=>{d.addEventListener("click",o)}),document.addEventListener("click",d=>{!d.target.closest("#navbar")&&n.classList.contains("mobile-open")&&o()}),document.addEventListener("keydown",d=>{d.key==="Escape"&&n.classList.contains("mobile-open")&&o()}),window.addEventListener("resize",()=>{window.innerWidth>768&&n.classList.contains("mobile-open")&&o()})}}function Mr(){document.querySelectorAll(".product-card").forEach(s=>{s.addEventListener("click",n=>{if(n.target.closest(".card-add-btn")||n.target.closest(".card-wishlist"))return;const o=s.dataset.productId;o&&(location.hash=`#/product/${o}`)})})}window.addEventListener("cart-updated",()=>{Es()});document.addEventListener("dblclick",s=>{s.target.closest("#mainNavBrand, .navbar-brand, .brand-name, .brand-info")&&(s.preventDefault(),s.stopPropagation(),location.hash="#/admin",Y("Admin Portal","Opening Admin Panel...","info"))});window.addEventListener("scroll",()=>{const s=document.getElementById("navbar");s&&s.classList.toggle("scrolled",window.scrollY>30)},{passive:!0});function $s(){nr(),mr(),vr(),br(),_r(),$r(),Sr(),Tr(),Or(),jr(),window.addEventListener("hashchange",Oi),Oi()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$s):$s();
